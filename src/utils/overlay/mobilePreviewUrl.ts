...
export function readMobilePreviewUrl(fallback: string): string {
...
export function persistMobilePreviewUrl(url: string) {
    try {
...
export function normalizeMobilePreviewUrl(input: string, baseUrl: string): string | null {
