...
export type ReportMessages = {
    ...
    apiFlow: {
        ...
        detailError: string;
        summaryTotal: (total: number, failures: number) => string;
        summaryRequests: (total: number) => string;
        ...
        draftBannerAttach: string;
        feedbackTitle: string;
        feedbackUrl: string;
        feedbackQueryParams: string;
        feedbackRequestBody: string;
        feedbackResponseBody: string;
    ...
    settings: {
        ...
        devicePreviewScaleAriaLabel: string;
        devicePreviewImageLabel: string;
        ...
        mobilePreviewUrlAriaLabel: string;
        mobilePreviewUrlPlaceholder: string;
        mobilePreviewUrlGoLabel: string;
        mobilePreviewQrOpenLabel: string;
        mobilePreviewQrOpenAriaLabel: string;
    ...
    marker: {
        ...
        askAi: {
            ...
            fullReview: string;
            fullModification: string;
            selectedCaseReview: string;
            threadModification: string;
            threadReview: string;
            threadFloatingAriaLabel: string;
            copied: string;
            prompt: {
