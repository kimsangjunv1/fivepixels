...
export const en: ReportMessages = {
    ...
    onboarding: {
        ...
        displayStepTitle: "Choose marker and font size",
        displayStepDescription: "Set how large markers and text appear on the page.",
    ...
    settings: {
        ...
        categoryTeam: "Team",
        categoryTeamSummary: "Members · Requests · Roles",
    ...
    team: {
        localStorageHint: "localStorage mode shows the configured team.reviewers list only. Approvals and role changes need API handlers.",
        apiAdminHint: "Approve registration requests, change roles, or deactivate members.",
        apiMemberHint: "View team members. Submit a registration request if you are still pending approval.",
