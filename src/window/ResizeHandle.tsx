import type { ResizeEdge } from "@/hooks/useGhostCornerResize.js";
...
const CURSOR_CLASS: Record<ResizeEdge, string> = {
...
function EdgeHandleIcon({ edge, active }: { edge: ResizeEdge; active: boolean }) {
...
export function ResizeHandle({ edge, ariaLabel, inactive = false, active = false, onPointerDown }: ResizeHandleProps) {
