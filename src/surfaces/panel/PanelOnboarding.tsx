...
import { resolveFivePixelsSync, resolveRequireAuth, usesRemoteAuthLogin, type FivePixelsSync } from "@/shared/constants/loginMethod.js";
import { MARKER_FILL_STYLE_VALUES, type AppearanceScale, type MarkerFillStyle, type MarkerShape } from "@/shared/constants/markerAppearance.js";
import { PANEL_ROLE_VALUES, type PanelRole } from "@/shared/constants/panelRole.js";
...
export function PanelOnboarding() {
    ...
    const [step, setStep] = useState<OnboardingStep>(() => resolveInitialOnboardingStep(sync, requireAuth, selfProfile?.completed));
