...
export function FloatingMobilePreview() {
    ...
    const [position, setPosition] = useState<WindowPosition>(() => readMobilePreviewPosition());
    ...
    return (
        <OverlayShell
            ...
            minimizePolicy="dock"
            dataChrome="mobile-preview"
            ariaLabel={messages.panel.mobilePreview}
            position={position}
            ...
            contentClassName="flex items-center justify-center p-[16px]"
            minimizedDockSubtitle={messages.panel.mobilePreview}
            controls={{
                onClose: handleClose,
            ...
            title={<span className="truncate text-[12px] font-bold text-[var(--adaptive-black900)]">{messages.panel.mobilePreview}</span>}
        >
            <div
