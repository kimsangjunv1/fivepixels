...
const FIELD_LABELS: Record<"projectId" | "environment" | "authorId" | "publicKey", string> = {
    projectId: "projectId",
...
function maskValue(value: string | null, field: "projectId" | "environment" | "authorId" | "publicKey") {
    if (!value) {
        return "-";
    }
