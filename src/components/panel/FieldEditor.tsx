        ...
        <>
            {fields.map((field) => {
                if (field.key === "message") {
                    return (
                        <label key={field.key} className={isDraftBubble ? "flex flex-col gap-1" : "flex flex-col gap-1 text-xs"}>
                            {isDraftBubble ? (
                        ...
                        <label
                            ...
                            className={
                                isDraftBubble
                                    ...
                                    : "flex flex-row items-center gap-2 text-xs text-slate-700 dark:text-slate-200"
                            }
                        >
                            <input
                                type="checkbox"
