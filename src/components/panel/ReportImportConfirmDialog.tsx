...
export function ReportImportConfirmDialog({ onApply, onCancel, onBackupAndApply }: ReportImportConfirmDialogProps) {
    return (
        <section className="mx-[4px] mb-[4px] rounded-[12px] border border-[var(--adaptive-black200)] bg-white p-[14px] shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
            ...
            <div className="mt-[14px] flex items-center justify-end gap-[10px]">
                <button
                    type="button"
                    onClick={onApply}
                    className="font-semibold text-[var(--adaptive-black700)]"
                >
                    바로 반영
                </button>
                <button
                ...
                <button
                    ...
                    className="rounded-[8px] bg-[#dbeafe] px-[12px] py-[6px] font-bold text-[var(--adaptive-blue500)]"
                >
                    백업 후 반영
                </button>
            </div>
