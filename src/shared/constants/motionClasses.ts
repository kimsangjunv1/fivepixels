 ...
 * Definitions live in `src/shared/styles/motion.css` — tune animations there.
 */
export const MOTION = {
...
export function panelTabPaneClass(direction: "left" | "right" | "open" | null): string {
    if (direction === "left") {
...
export function panelTabPaneExitClass(direction: "left" | "right" | "open" | null): string {
    if (direction === "right") {
