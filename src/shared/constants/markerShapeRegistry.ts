...
import { MATERIAL_SHAPE_PATHS, type MaterialShapePathId } from "@/shared/constants/markerShapePaths.js";
...
function svgEntry(id: MaterialShapePathId): MarkerShapeDefinition {
 ...
 */
export const MARKER_SHAPE_REGISTRY: Record<MarkerShape, MarkerShapeDefinition> = {
...
export function getMarkerShapeDefinition(shape: MarkerShape): MarkerShapeDefinition {
