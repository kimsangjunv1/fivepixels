...
import { serializeMentionToken } from "@/shared/types/mention.js";
import { getAtQuery, replaceActiveMentionQuery } from "@/shared/utils/mention/elementMentions.js";
import {
    MENTION_CARET_GUARD,
    renderMentionEditorContent,
    serializeMentionEditor,
    serializeMentionEditorBeforeCaret,
} from "@/shared/utils/mention/mentionComposerDom.js";
