import { isRemoteLoginMethod, type FivePixelsSync } from "@/shared/constants/loginMethod.js";
import { createLocalStorageReportAdapter } from "@/shared/storage/local/localStorageAdapter.js";
...
export type AdapterHandlerName =
    ...
    | "adapter.feedback.updateAssignee"
    | "adapter.feedback.updateStatus"
    | "adapter.cases.update"
    | "adapter.feedback.delete"
    | "adapter.replies.list"
    | "adapter.replies.create"
    | "adapter.replies.update"
    | "adapter.replies.delete"
    | "adapter.auth.login"
    | "adapter.auth.signup"
    | "adapter.auth.logout"
    ...
    | "adapter.cases.list"
    | "adapter.cases.listByProject"
    | "adapter.cases.get"
    | "adapter.cases.create"
    | "adapter.cases.updateAssignee"
    | "adapter.cases.updateStatus"
