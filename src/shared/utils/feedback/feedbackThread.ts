...
import type { ReportAuthor, ReportFeedback, ReportReply, ReportReplyStatus } from "@/shared/types/report.js";
 ...
 */
export function resolveDenyComposerType(latestRoot: Pick<ReportReply, "status"> | null): "deny" | "recheck" {
