...
import { ensureReportLocaleMessages, getReportMessages, setActiveReportMessages } from "@/shared/i18n/index.js";
...
import { useDevicePreviewPreference } from "@/surfaces/preview/useDevicePreviewPreference.js";
import { useMobilePreviewPreference } from "@/surfaces/preview/useMobilePreviewPreference.js";
...
import { PANEL_APPEARANCE_STORAGE_KEY, TOOLTIP_APPEARANCE_STORAGE_KEY } from "@/shared/constants/appearance.js";
...
import { buildPanelStats } from "@/shared/utils/panel/panelBootstrap.js";
import { buildPanelRoleStats } from "@/shared/utils/panel/panelRoleStats.js";
import { getPanelRoleTabPreset } from "@/shared/constants/panelTabPresets.js";
import { getPanelTabDefinition, isUserSelectablePanelTab, shouldEnableAllReportsFetch, type UserSelectablePanelTab } from "@/shared/constants/panelTabRegistry.js";
import {
    formatVisibleTabSummary,
    resolveDefaultPanelTab,
    resolveVisibleTabs,
    type PanelTabPreference,
} from "@/shared/utils/panel/panelTabPreference.js";
...
import { parseFeedbackDeepLink } from "@/shared/utils/feedback/feedbackDeepLink.js";
