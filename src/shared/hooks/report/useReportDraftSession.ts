...
import type { CreateReportFeedbackPayload, ReportAuthor, ReportFeedback, ReportField, ReportIdentify } from "@/shared/types/report.js";
import type { ElementMention } from "@/shared/types/mention.js";
import type { DraftReport, HoverPointer, ReportMode, TargetSnapshot } from "@/shared/types/report-ui.js";
...
import { findPickTargetByPoint, getSelectableTargets, isSameHoverTarget, resolveFeedbackDocumentAnchor, toFeedbackHoverSnapshot } from "@/shared/utils/shared/dom.js";
import { createInitialFieldValues, getFieldError } from "@/shared/utils/report/fields.js";
import { getPickProbeElementKey } from "@/shared/utils/probe/pickProbeSession.js";
...
import type { SessionActor } from "@/shared/utils/report/reportTeam.js";
import { buildDraftFromReport } from "@/shared/utils/report/buildDraftFromReport.js";
import { getPageScrollY, getPageViewportSize, mapHostPointToPage } from "@/shared/utils/overlay/pageDocumentBridge.js";
import { useReportPickProbe } from "./useReportPickProbe.js";
import { getFeedbackViewPath } from "@/shared/utils/marker/viewRestore.js";
import type { ApiFlowEntry } from "@/shared/types/networkMonitor.js";
import { formatApiFlowEntryForFeedback } from "@/shared/utils/network/formatApiFlowEntry.js";
...
export function useReportDraftSession({
    ...
    const updateDraftCase = (caseId: string, text: string, mentions?: ElementMention[], userMentions?: import("@/shared/types/mention.js").UserMention[]) => {
        setDraft((current) => {
            if (!current) {
                return current;
            }
