...
export declare const THREAD_ACTION_ENTRY_SURFACE_CLASS = "flex flex-col gap-[4px] rounded-[12px] border-[1px] border-[var(--adaptive-black300)] bg-[var(--adaptive-surface-overlay)] p-[8px_12px]";
