...
export function CaseResolvedBadge({ resolvedLabel, openLabel, resolved }) {
    ...
    return (_jsx("span", { className: "inline-flex h-[14px] w-[14px] shrink-0 items-center justify-center rounded-full bg-[var(--adaptive-green500)] text-[12px] font-bold leading-none text-white", "aria-label": resolved ? resolvedLabel : openLabel, children: "\u2713" }));
}
