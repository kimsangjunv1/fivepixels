...
import { GitHubIcon } from "../../shared/components/icons/Icons.js";
import { HoverTooltip } from "../../surfaces/tooltip/HoverTooltip.js";
import { getGitHubIssueUrl, hasGitHubIssue } from "../../shared/utils/github/githubIntegration.js";
export function GitIssueButton({ report, messages, disabled = false, isSubmitting = false, onCreateIssue }) {
    ...
    if (hasGitHubIssue(report) && issueUrl) {
        return (_jsx(HoverTooltip, { label: messages.feedbackList.gitIssueViewTitle, children: _jsx("a", { href: issueUrl, target: "_blank", rel: "noopener noreferrer", "data-fivepixels-interactive": "", onClick: (event) => event.stopPropagation(), "aria-label": messages.feedbackList.gitIssueViewAriaLabel, className: "flex shrink-0 items-center justify-center self-start rounded-[6px] p-[6px] text-[var(--adaptive-black500)] hover:bg-[var(--adaptive-black100)] hover:text-[var(--adaptive-blue500)]", children: _jsx(GitHubIcon, { className: "h-[16px] w-[16px]" }) }) }));
    }
