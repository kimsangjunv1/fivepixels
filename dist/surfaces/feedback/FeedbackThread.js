...
function ThreadStartedDivider({ createdAt }) {
    ...
    return (_jsx(ThreadTimelineRow, { children: _jsxs("div", { className: "flex items-center gap-[8px]", role: "status", children: [_jsx("span", { "aria-hidden": true, className: "h-px flex-1 bg-[var(--adaptive-border-subtle)]" }), _jsx("span", { className: "inline-flex shrink-0 items-center gap-[6px]", children: _jsx("span", { className: "text-[14px] font-bold leading-none tabular-nums", style: { color: dateColor }, children: formatDateOnly(createdAt, locale) }) }), _jsx("span", { "aria-hidden": true, className: "h-px flex-1 bg-[var(--adaptive-border-subtle)]" })] }) }));
}
function ThreadDetachedTargetDivider() {
    ...
    return (_jsx(ThreadTimelineRow, { children: _jsxs("div", { className: "flex items-center gap-[8px]", role: "status", children: [_jsx("span", { "aria-hidden": true, className: "h-px flex-1 bg-[var(--adaptive-border-subtle)]" }), _jsx("span", { className: "inline-flex shrink-0 items-center gap-[6px]", children: _jsx("span", { className: "text-[14px] font-bold leading-none", style: { color: labelColor }, children: messages.thread.detachedTargetDivider }) }), _jsx("span", { "aria-hidden": true, className: "h-px flex-1 bg-[var(--adaptive-border-subtle)]" })] }) }));
}
