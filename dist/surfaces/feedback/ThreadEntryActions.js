...
import { buildConfirmAuthorOptions, canShowAdjudicationActionsOnBranchReply, canShowCaseClaimAction, canShowCaseEntryActions, canShowCheckoutBranchActionsForCase, canShowSuggestedBranchActionsForCase, isBranchReplyAuthor, } from "../../shared/utils/feedback/feedbackThread.js";
import { getThreadActionButtonClass, THREAD_ACTION_STYLE } from "../../shared/constants/threadActionStyles.js";
import { AskActionIcon, CheckIcon, CompleteActionIcon, DeniedActionIcon } from "../../shared/components/icons/Icons.js";
...
export const THREAD_ACTION_ENTRY_SURFACE_CLASS = "flex flex-col gap-[4px] rounded-[12px] border-[1px] border-[var(--adaptive-black300)] bg-[var(--adaptive-surface-overlay)] p-[8px_12px]";
