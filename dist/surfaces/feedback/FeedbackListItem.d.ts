...
export declare function FeedbackListItem({ report, locale, messages, listKind, disabled, canCreateGitHubIssue, creatingGitHubIssueId, onLocate, onDelete, onCreateGitHubIssue, }: FeedbackListItemProps): import("react").JSX.Element;
export {};
