...
const MENU_TOOLTIP_ITEM_CLASS = "flex w-full items-center gap-[8px] rounded-[8px] px-[4px] py-[4px] text-left text-[14px] font-medium leading-[1.5] text-[var(--adaptive-black900)] hover:bg-[var(--adaptive-black100)] disabled:cursor-not-allowed disabled:opacity-50";
