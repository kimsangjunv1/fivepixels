...
function ProbeLayoutSectionLabel({ children }) {
    return _jsx("span", { className: "text-[14px] font-medium leading-[1.5] text-[var(--adaptive-black500)]", children: children });
}
