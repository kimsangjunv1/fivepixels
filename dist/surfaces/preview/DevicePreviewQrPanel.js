...
export function DevicePreviewQrPanel({ pageHref, title, hintLocalhost, urlInputLabel, urlInputPlaceholder, urlInputAriaLabel, invalidUrlMessage, emptyUrlMessage, copyLabel, copiedLabel, copyAriaLabel, qrAriaLabel, className = "", width = 220, }) {
    ...
    return (_jsxs("div", { "data-fivepixels-interactive": "", className: `pointer-events-auto flex flex-col gap-[4px] ${className}`.trim(), style: { width }, role: "region", "aria-label": title, children: [_jsx("div", { className: "overflow-hidden rounded-[16px] border border-[var(--adaptive-border-subtle)] bg-white", children: qr ? (_jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: `0 0 ${qr.dimension} ${qr.dimension}`, className: "block aspect-square w-full", role: "img", "aria-label": qrAriaLabel, children: [_jsx("rect", { width: qr.dimension, height: qr.dimension, fill: "#ffffff" }), _jsx("path", { d: qr.path, fill: "#0f172a" })] })) : (_jsx("div", { className: "flex aspect-square w-full items-center justify-center border border-dashed border-[rgba(148,163,184,0.55)] bg-[rgba(248,250,252,0.92)] px-[10px] text-center text-[12px] font-medium leading-snug text-slate-500", "aria-hidden": true, children: "QR" })) }), _jsxs("section", { className: "rounded-[12px] bg-[var(--adaptive-fillOpacity700)] overflow-hidden shadow-[var(--adaptive-popup-shadow)] backdrop-blur-[10px]", children: [resolved.needsManualUrl ? (_jsxs("div", { className: "flex gap-[4px] bg-[var(--adaptive-neutralTintOpacity900)]", children: [_jsxs("label", { className: "flex flex-col gap-[3px]", children: [_jsx("span", { className: "sr-only", children: urlInputLabel }), _jsx("input", { type: "url", value: manualUrl, onChange: (event) => setManualUrl(event.target.value), placeholder: urlInputPlaceholder, "aria-label": urlInputAriaLabel, className: "h-[30px] w-full px-[10px] text-[var(--adaptive-black900)] outline-none placeholder:text-[var(--adaptive-black500)] focus:border-[var(--adaptive-blue500)]" })] }), resolved.url ? (_jsx("div", { className: "flex flex-col gap-[6px]", children: _jsx("button", { type: "button", onClick: () => void handleCopy(), "aria-label": copyAriaLabel, className: "h-[28px] rounded-[8px] border border-[var(--adaptive-border-subtle)] bg-[var(--adaptive-black50)] px-[8px] text-[12px] font-semibold text-[var(--adaptive-black900)] hover:bg-[var(--adaptive-black100)]", children: copied ? copiedLabel : copyLabel }) })) : null] })) : null, _jsx("p", { className: "text-[12px] text-[var(--adaptive-black500)] leading-[1.5] whitespace-break-spaces px-[10px] py-[6px]", children: hintLocalhost })] })] }));
}
