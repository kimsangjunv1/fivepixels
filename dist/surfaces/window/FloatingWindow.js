...
import { MoreHorizontalIcon } from "../../shared/components/icons/Icons.js";
...
import { WINDOW_EXPANDED_CONTROLS_WIDTH, WINDOW_HEADER_BUTTON_CLASS, WINDOW_HEADER_GAP, WindowModeControls, } from "../../surfaces/window/WindowModeControls.js";
import { MinimizedDockSimpleSubtitleRow, MinimizedDockWindowChrome, } from "../../surfaces/window/MinimizedDockWindowChrome.js";
import { clampWindowPosition, useDraggableWindow } from "../../shared/hooks/useDraggableWindow.js";
...
import { getMaximizedWindowFrame, getWindowViewportSize, useWindowMode } from "../../shared/hooks/useWindowMode.js";
import { claimFloatingWindowZIndex, getFloatingWindowZBase } from "../../shared/utils/overlay/floatingWindowStack.js";
import { MINIMIZED_WINDOW_HEIGHT } from "../../shared/utils/overlay/minimizedDockLayout.js";
const DEFAULT_MIN_WIDTH = 200;
const DEFAULT_MIN_HEIGHT = 120;
const MAXIMIZE_MARGIN = 12;
export function FloatingWindow({ children, title, headerRight, controls, showControls = true, mode: modeProp, defaultMode = "normal", onModeChange, minimizePolicy = "inplace", windowId, className = "", contentClassName = "", headerClassName = "", style, width, height, minWidth = DEFAULT_MIN_WIDTH, minHeight = DEFAULT_MIN_HEIGHT, resizable = true, resizeAriaLabel = "Resize window", zIndex, enabled = true, position, onPositionChange, onSizeChange, ariaLabel, dataChrome, role, minimizedDockBadgeLabel = "common ui", minimizedDockBadgeValue, minimizedDockSubtitle, }) {
    ...
    return (_jsxs(_Fragment, { children: [isResizing ? _jsx(CornerResizeGhost, { ghostRef: ghostRef }) : null, _jsx("div", { ref: windowRef, "data-fivepixels-interactive": "", "data-fp-chrome": dataChrome, "data-dragging": isDragging ? "true" : "false", "data-mode": mode, role: role, "aria-label": ariaLabel, onPointerDown: handleWindowPointerDown, className: `pointer-events-auto fixed flex flex-col rounded-[16px] shadow-[var(--adaptive-popup-shadow)] ${showDockMinimizedChrome
                    ? "overflow-hidden"
                    : `bg-[var(--adaptive-black50)]/95 backdrop-blur-[10px] ${resizable && mode === "normal" ? "overflow-visible" : "overflow-hidden"}`} ${className}`, style: {
                    ...
                    ...style,
                }, children: showDockMinimizedChrome ? (_jsx(MinimizedDockWindowChrome, { badgeLabel: minimizedDockBadgeLabel, badgeValue: minimizedDockBadgeValue, restoreAriaLabel: minimizeAriaLabel, restoreTitle: minimizeAriaLabel, onRestore: handleMinimize, restoreDisabled: dockMorphActive, closeAriaLabel: closeAriaLabel, closeTitle: closeAriaLabel, onClose: handleClose, closeDisabled: dockMorphActive || isDockDragging, dockCount: overlayDock.dockCount, isDockDragging: isDockDragging, onPointerDown: dockDrag.handleMinimizedDockPointerDown, onClickCapture: dockDrag.handleMinimizedDockClickCapture, children: resolvedMinimizedSubtitle ? (_jsx(MinimizedDockSimpleSubtitleRow, { label: resolvedMinimizedSubtitle, onRestore: handleMinimize, restoreDisabled: dockMorphActive, restoreAriaLabel: minimizeAriaLabel })) : null })) : (_jsxs(_Fragment, { children: [_jsxs("header", { ref: headerRef, onPointerDown: handleHeaderPointerDown, onClickCapture: showDockMinimizedChrome ? dockDrag.handleMinimizedDockClickCapture : undefined, onDoubleClick: handleHeaderDoubleClick, className: `relative flex shrink-0 touch-none select-none items-center gap-[10px] px-[12px] py-[8px] ${dragEnabled || (showDockMinimizedChrome && overlayDock.dockCount > 1)
