...
import { APPEARANCE_OPTION_VALUES } from "../../shared/constants/appearance.js";
import { resolveFivePixelsSync, resolveRequireAuth, usesRemoteAuthLogin } from "../../shared/constants/loginMethod.js";
...
const THREAD_LAYOUT_OPTIONS = ["classic", "feed"];
function SettingsSection({ label, children }) {
    return (_jsxs("section", { className: "flex flex-col border-b border-[var(--adaptive-border-subtle)] last:border-b-0", children: [_jsx("p", { className: "px-[12px] pt-[10px] pb-[4px] text-[12px] font-semibold uppercase tracking-[0.02em] text-[var(--adaptive-black500)]", children: label }), _jsx("div", { className: "flex flex-col py-[2px]", children: children })] }));
}
function SettingsActionButton({ disabled = false, locked = false, lockLabel, onClick, children, }) {
    const button = (_jsx("button", { type: "button", disabled: disabled || locked, onClick: onClick, className: "w-full rounded-[8px] px-[12px] py-[8px] text-left text-[14px] text-[var(--adaptive-black800)] hover:bg-[var(--adaptive-black100)] disabled:cursor-not-allowed disabled:opacity-50", children: _jsxs("span", { className: "inline-flex items-center gap-[6px]", children: [locked ? _jsx(LockIcon, { className: "h-[12px] w-[12px] shrink-0 text-[var(--adaptive-black500)]" }) : null, children] }) }));
    if (!locked || !lockLabel) {
        return button;
    }
    return (_jsx(HoverTooltip, { label: lockLabel, multiline: true, className: "w-full", children: button }));
}
function SettingsHubRow({ title, subtitle, onClick, locked = false, lockLabel }) {
    return (_jsxs("button", { type: "button", onClick: onClick, className: "flex w-full items-center gap-[10px] border-b border-[var(--adaptive-border-subtle)] px-[12px] py-[10px] text-left last:border-b-0 hover:bg-[var(--adaptive-black100)]", children: [_jsxs("div", { className: "min-w-0 flex-1 flex flex-col gap-[4px]", children: [_jsxs("p", { className: "inline-flex items-center gap-[6px] text-[14px] font-semibold text-[var(--adaptive-black900)]", children: [title, locked ? (_jsx(HoverTooltip, { label: lockLabel, multiline: true, children: _jsx("span", { className: "inline-flex text-[var(--adaptive-black500)]", children: _jsx(LockIcon, { className: "h-[12px] w-[12px]" }) }) })) : null] }), _jsx("p", { className: "truncate text-[12px] text-[var(--adaptive-black700)]", children: subtitle })] }), _jsx(ChevronRightIcon, { className: "h-[14px] w-[14px] shrink-0 text-[var(--adaptive-black400)]" })] }));
}
...
export function PanelSettings({ transferDisabled = false, panelAppearance, onPanelAppearanceChange, tooltipAppearance, onTooltipAppearanceChange, questionThreadDisplay, onQuestionThreadDisplayChange, threadLayout, onThreadLayoutChange, onExport, onImport, onCommand, hasPersonalKey, onKeyCopy, onPublicKeyCopy, onKeyInsert, onKeyRotate, initialCategory = null, }) {
    ...
    const { locale, setLocale, messages, showMarkerTargetPreview, setShowMarkerTargetPreview, isPresentationMode, presentationViewers, markerAppearance, setMarkerSize, setMarkerShape, setMarkerFillStyle, setMarkerColor, setMarkerStrokeColor, setFeedbackModeDotColors, setFeedbackModeDotColor, typography, setFontFamily, panelRole, visiblePanelTabs, visiblePanelTabsSummary, resolvedTabAvailabilityContext, setVisiblePanelTabs, resetVisibleTabsToRoleDefault, canAccessTeamSettings, integrationCapabilities, adapterIntegrationStatus, loginMethod, requireAuth: requireAuthProp, logoutWithApi, } = useReportPreferences();
        ...
        return (_jsxs("section", { className: "flex min-h-0 flex-1 flex-col overflow-hidden bg-[var(--adaptive-black50)]", children: [_jsx(SettingsDetailHeader, { title: detailTitle, backAriaLabel: detailBackAriaLabel, onBack: () => {
                        ...
                        setActiveCategory(null);
                                        ...
                                        return (_jsx("button", { type: "button", role: "radio", "aria-checked": active, disabled: option.disabled, onClick: () => {
                                            ...
                                            }, className: `rounded-[8px] px-[12px] py-[8px] text-left text-[14px] transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${active
                                    ...
                                    }) })] })) : null, activeAppearanceSection === "theme-language" ? (_jsxs(_Fragment, { children: [_jsx(SettingsSection, { label: messages.settings.sectionTheme, children: _jsxs("div", { className: "flex flex-col gap-[10px] px-[12px] pb-[10px]", children: [_jsxs("div", { children: [_jsx("p", { className: "mb-[6px] text-[12px] font-medium text-[var(--adaptive-black600)]", children: messages.moreMenu.panelTheme }), _jsx(AppearanceThemePicker, { options: appearanceOptions, value: panelAppearance, onChange: onPanelAppearanceChange, ariaLabel: messages.moreMenu.panelThemeAriaLabel, previewKind: "panel" })] }), _jsxs("div", { children: [_jsx("p", { className: "mb-[6px] text-[12px] font-medium text-[var(--adaptive-black600)]", children: messages.moreMenu.tooltipTheme }), _jsx(AppearanceThemePicker, { options: appearanceOptions, value: tooltipAppearance, onChange: onTooltipAppearanceChange, ariaLabel: messages.moreMenu.tooltipThemeAriaLabel, previewKind: "tooltip" })] })] }) }), _jsx(SettingsSection, { label: messages.settings.sectionLanguage, children: _jsx("div", { className: "px-[12px] pb-[10px]", children: _jsx(OptionSwitch, { options: localeOptions, value: locale, onChange: setLocale, ariaLabel: messages.moreMenu.languageAriaLabel }) }) })] })) : null, activeAppearanceSection === "thread-layout" ? (_jsxs(_Fragment, { children: [_jsx(SettingsSection, { label: messages.settings.sectionThreadLayout, children: _jsx("div", { className: "px-[12px] pb-[10px]", children: _jsx(OptionSwitch, { options: threadLayoutOptions, value: threadLayout, onChange: onThreadLayoutChange, ariaLabel: messages.settings.sectionThreadLayout }) }) }), _jsx(SettingsSection, { label: messages.moreMenu.questionThread, children: _jsx("div", { className: "px-[12px] pb-[10px]", children: _jsx(OptionSwitch, { options: questionThreadOptions, value: questionThreadDisplay, onChange: onQuestionThreadDisplayChange, ariaLabel: messages.moreMenu.questionThreadAriaLabel }) }) })] })) : null, activeAppearanceSection === "feedback-mode" ? (_jsx(SettingsSection, { label: messages.settings.sectionFeedbackMode, children: _jsxs("div", { className: "flex flex-col gap-[12px] px-[12px] pb-[10px]", children: [_jsx(HexColorField, { label: messages.settings.feedbackModeDotColorLight, value: markerAppearance.feedbackModeDotColors.light, onChange: (color) => setFeedbackModeDotColor("light", color) }), _jsx(HexColorField, { label: messages.settings.feedbackModeDotColorDark, value: markerAppearance.feedbackModeDotColors.dark, onChange: (color) => setFeedbackModeDotColor("dark", color) }), _jsx(SettingsActionButton, { onClick: () => setFeedbackModeDotColors(DEFAULT_FEEDBACK_MODE_DOT_COLORS), children: messages.settings.resetFeedbackModeDotColors })] }) })) : null, activeAppearanceSection === "marker" ? (_jsxs(_Fragment, { children: [_jsx(SettingsSection, { label: messages.settings.sectionMarkerForm, children: _jsxs("div", { className: "flex flex-col gap-[12px] px-[12px] pb-[10px]", children: [_jsx(PanelMarkerDisplayControls, { markerSize: markerAppearance.size, onMarkerSizeChange: setMarkerSize, scaleLabels: scaleLabels, markerSizeLabel: messages.settings.markerSize, markerSizeAriaLabel: messages.settings.markerSizeAriaLabel }), _jsxs("div", { children: [_jsx("p", { className: "mb-[6px] text-[12px] font-medium text-[var(--adaptive-black600)]", children: messages.settings.markerFillStyle }), _jsx(OptionSwitch, { options: MARKER_FILL_STYLE_VALUES.map((value) => ({
                                                            value,
                                                            label: fillStyleLabels[value],
                                                        })), value: markerAppearance.fillStyle, onChange: setMarkerFillStyle, ariaLabel: messages.settings.markerFillStyleAriaLabel })] }), _jsxs("div", { children: [_jsx("p", { className: "mb-[6px] text-[12px] font-medium text-[var(--adaptive-black600)]", children: messages.settings.markerShape }), _jsx(MarkerShapePicker, { value: markerAppearance.shape, onChange: setMarkerShape, labels: shapeLabels, ariaLabel: messages.settings.markerShapeAriaLabel, previewColor: markerAppearance.colors.open, fillStyle: markerAppearance.fillStyle, strokeColor: markerAppearance.strokeColor })] })] }) }), showFillColorSettings ? (_jsx(SettingsSection, { label: messages.settings.sectionMarkerFillColors, children: _jsxs("div", { className: "flex flex-col gap-[12px] px-[12px] pb-[10px]", children: [_jsx(HexColorField, { label: messages.settings.markerColorOpen, value: markerAppearance.colors.open, onChange: (color) => setMarkerColor("open", color) }), _jsx(HexColorField, { label: messages.settings.markerColorResolved, value: markerAppearance.colors.resolved, onChange: (color) => setMarkerColor("resolved", color) }), _jsx(HexColorField, { label: messages.settings.markerColorGitIssued, value: markerAppearance.colors.gitIssued, onChange: (color) => setMarkerColor("gitIssued", color) })] }) })) : null, showStrokeStatusColorSettings ? (_jsx(SettingsSection, { label: messages.settings.sectionMarkerStrokeColors, children: _jsxs("div", { className: "flex flex-col gap-[12px] px-[12px] pb-[10px]", children: [_jsx(HexColorField, { label: messages.settings.markerColorOpen, value: markerAppearance.colors.open, onChange: (color) => setMarkerColor("open", color) }), _jsx(HexColorField, { label: messages.settings.markerColorResolved, value: markerAppearance.colors.resolved, onChange: (color) => setMarkerColor("resolved", color) }), _jsx(HexColorField, { label: messages.settings.markerColorGitIssued, value: markerAppearance.colors.gitIssued, onChange: (color) => setMarkerColor("gitIssued", color) })] }) })) : null, showBothStrokeColorSetting ? (_jsx(SettingsSection, { label: messages.settings.sectionMarkerStrokeColors, children: _jsx("div", { className: "flex flex-col gap-[12px] px-[12px] pb-[10px]", children: _jsx(HexColorField, { label: messages.settings.markerStrokeColor, value: markerAppearance.strokeColor, onChange: setMarkerStrokeColor }) }) })) : null, _jsx(SettingsSection, { label: messages.settings.sectionTypography, children: _jsx("div", { className: "flex flex-col gap-[12px] px-[12px] pb-[10px]", children: _jsxs("label", { className: "flex flex-col gap-[4px] text-[12px]", children: [_jsx("span", { className: "font-medium text-[var(--adaptive-black500)]", children: messages.settings.fontFamily }), _jsx("input", { type: "text", list: "fivepixels-font-family-suggestions", value: typography.fontFamily, onChange: (event) => setFontFamily(event.target.value), "aria-label": messages.settings.fontFamilyAriaLabel, className: "w-full rounded-[8px] border border-[var(--adaptive-border-subtle)] bg-[var(--adaptive-black50)] px-[8px] py-[6px] text-[12px] text-[var(--adaptive-black900)] outline-none focus:border-[var(--adaptive-blue500)]" }), _jsx("datalist", { id: "fivepixels-font-family-suggestions", children: FONT_FAMILY_SUGGESTIONS.map((family) => (_jsx("option", { value: family }, family))) })] }) }) })] })) : null, activeCategory === "display" ? (_jsx(SettingsSection, { label: messages.settings.sectionMarker, children: _jsx("div", { className: "px-[12px] pb-[10px]", children: _jsx(OptionSwitch, { options: [
                                        { value: "off", label: messages.settings.markerTargetsOff },
                                        { value: "on", label: messages.settings.markerTargetsOn },
                                    ], value: showMarkerTargetPreview ? "on" : "off", onChange: (value) => setShowMarkerTargetPreview(value === "on"), ariaLabel: messages.settings.markerTargetsAriaLabel }) }) })) : null, activeCategory === "tabs" ? (_jsx(SettingsSection, { label: messages.settings.categoryTabs, children: _jsxs("div", { className: "flex flex-col gap-[12px] px-[12px] pb-[10px]", children: [_jsx(PanelTabSelector, { role: panelRole, selectedTabs: visiblePanelTabs, context: resolvedTabAvailabilityContext, messages: messages, onChange: setVisiblePanelTabs }), _jsx(SettingsActionButton, { onClick: resetVisibleTabsToRoleDefault, children: messages.settings.resetTabsToRoleDefault })] }) })) : null, activeCategory === "team" ? _jsx(PanelTeamSettings, {}) : null, activeCategory === "data-and-keys" ? (_jsxs(_Fragment, { children: [_jsxs(SettingsSection, { label: messages.moreMenu.sectionTransfer, children: [_jsx(SettingsActionButton, { disabled: transferDisabled, locked: transferLock.locked, lockLabel: transferLock.tooltipLabel, onClick: onImport, children: messages.moreMenu.import }), _jsx(SettingsActionButton, { disabled: transferDisabled, locked: transferLock.locked, lockLabel: transferLock.tooltipLabel, onClick: onExport, children: messages.moreMenu.export })] }), _jsxs(SettingsSection, { label: messages.moreMenu.sectionKey, children: [_jsx(SettingsActionButton, { disabled: !hasPersonalKey, onClick: onPublicKeyCopy, children: messages.moreMenu.publicKeyCopy }), _jsx(SettingsActionButton, { disabled: !hasPersonalKey, onClick: onKeyCopy, children: messages.moreMenu.keyCopy }), _jsx(SettingsActionButton, { onClick: onKeyInsert, children: messages.moreMenu.keyInsert }), _jsx(SettingsActionButton, { disabled: !hasPersonalKey, onClick: onKeyRotate, children: messages.moreMenu.keyRotate })] })] })) : null, activeCategory === "advanced" ? (_jsx(SettingsSection, { label: messages.moreMenu.sectionAdvanced, children: _jsx(SettingsActionButton, { disabled: transferDisabled, locked: transferLock.locked, lockLabel: transferLock.tooltipLabel, onClick: onCommand, children: messages.moreMenu.command }) })) : null, activeCategory === "api-integration" ? _jsx(PanelIntegrationSettings, {}) : null] })] }));
    }
    return (_jsxs("section", { className: "flex min-h-0 flex-1 flex-col overflow-y-auto bg-[var(--adaptive-fillOpacity500)]", children: [_jsx("p", { className: "shrink-0 border-b border-[var(--adaptive-border-subtle)] px-[12px] py-[10px] text-[14px] font-semibold text-[var(--adaptive-black900)]", children: messages.settings.hubTitle }), showPreviewCategory ? (_jsx(SettingsHubRow, { title: messages.settings.categoryPreview, subtitle: activeViewerLabel, onClick: () => setActiveCategory("preview") })) : null, _jsx(SettingsHubRow, { title: messages.settings.categoryAppearance, subtitle: appearanceSummary, onClick: () => {
                    setActiveAppearanceSection(null);
                    setActiveCategory("appearance");
                } }), _jsx(SettingsHubRow, { title: messages.settings.categoryDisplay, subtitle: displaySummary, onClick: () => setActiveCategory("display") }), _jsx(SettingsHubRow, { title: messages.settings.categoryTabs, subtitle: tabsSummary, onClick: () => setActiveCategory("tabs") }), canAccessTeamSettings ? (_jsx(SettingsHubRow, { title: messages.settings.categoryTeam, subtitle: messages.settings.categoryTeamSummary, locked: teamManageLock.locked, lockLabel: teamManageLock.tooltipLabel, onClick: () => setActiveCategory("team") })) : null, showApiIntegrationCategory ? (_jsx(SettingsHubRow, { title: messages.settings.categoryApiIntegration, subtitle: apiIntegrationSummary, onClick: () => setActiveCategory("api-integration") })) : null, _jsx(SettingsHubRow, { title: messages.settings.categoryDataAndKeys, subtitle: messages.settings.categoryDataAndKeysSummary, onClick: () => setActiveCategory("data-and-keys") }), _jsx(SettingsHubRow, { title: messages.settings.categoryAdvanced, subtitle: messages.moreMenu.command, onClick: () => setActiveCategory("advanced") }), showAccountLogout ? (_jsx("div", { className: "mt-auto border-t border-[var(--adaptive-border-subtle)]", children: _jsx(SettingsActionButton, { disabled: isLoggingOut, onClick: () => void handleLogout(), children: messages.moreMenu.logout }) })) : null] }));
}
