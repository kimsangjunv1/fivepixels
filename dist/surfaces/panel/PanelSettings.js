...
export function PanelSettings({ transferDisabled = false, panelAppearance, onPanelAppearanceChange, tooltipAppearance, onTooltipAppearanceChange, questionThreadDisplay, onQuestionThreadDisplayChange, threadLayout, onThreadLayoutChange, onExport, onImport, onCommand, hasPersonalKey, onKeyCopy, onPublicKeyCopy, onKeyInsert, onKeyRotate, initialCategory = null, initialAppearanceSection = null, }) {
    ...
    const { locale, setLocale, messages, showMarkerTargetPreview, setShowMarkerTargetPreview, markerAppearance, setMarkerSize, setMarkerShape, setMarkerFillStyle, setMarkerColor, setMarkerStrokeColor, setFeedbackModeDotColors, setFeedbackModeDotColor, typography, setFontFamily, panelRole, visiblePanelTabs, visiblePanelTabsSummary, resolvedTabAvailabilityContext, setVisiblePanelTabs, resetVisibleTabsToRoleDefault, canAccessTeamSettings, integrationCapabilities, adapterIntegrationStatus, loginMethod, requireAuth: requireAuthProp, logoutWithApi, } = useReportPreferences();
