...
import { canAssignTeamRole, canEditTeamMember, filterVisibleTeamMembers, hasTeamAdminHandlers, isJoinedTeamMember, isTeamWriteEnabled, listAssignableRoles, resolveAuthorRole, sortTeamReviewers, } from "../../shared/utils/report/teamManagement.js";
...
function MemberRow({ member, roleLabel, roleMessages, inactiveLabel, canEdit, canJoin, apiMode, assignableRoles, editRoleLabel, activateLabel, deactivateLabel, deleteLabel, joinLabel, onToggleActive, onChangeRole, onDelete, onJoin, }) {
    const inactive = member.isActive === false;
    const joined = isJoinedTeamMember(member);
    return (_jsxs("div", { className: "flex flex-col gap-[6px] border-b border-[var(--adaptive-border-subtle)] px-[12px] py-[10px] last:border-b-0", children: [_jsxs("div", { className: "flex items-start justify-between gap-[8px]", children: [_jsxs("div", { className: "min-w-0 flex-1", children: [_jsx("p", { className: `truncate text-[14px] font-semibold ${inactive ? "text-[var(--adaptive-black500)]" : "text-[var(--adaptive-black900)]"}`, children: member.name }), _jsx("p", { className: "truncate text-[12px] text-[var(--adaptive-black600)]", children: member.id })] }), joined ? (_jsx("span", { className: "shrink-0 rounded-[4px] bg-[var(--adaptive-black100)] px-[6px] py-[2px] text-[12px] font-semibold text-[var(--adaptive-black700)]", children: roleLabel })) : canJoin && onJoin ? (_jsx("button", { type: "button", onClick: onJoin, className: "shrink-0 rounded-[6px] bg-[var(--adaptive-blue50)] px-[8px] py-[4px] text-[12px] font-semibold text-[var(--adaptive-blue500)] hover:bg-[color-mix(in_srgb,var(--adaptive-blue500)_12%,transparent)]", children: joinLabel })) : null] }), inactive ? _jsx("p", { className: "text-[12px] text-[var(--adaptive-black500)]", children: inactiveLabel }) : null, canEdit ? (_jsxs("div", { className: "flex flex-col gap-[6px]", children: [onChangeRole ? (_jsxs("div", { className: "flex flex-col gap-[4px]", children: [_jsx("p", { className: "text-[12px] font-semibold text-[var(--adaptive-black600)]", children: editRoleLabel }), _jsx("div", { className: "flex flex-wrap gap-[6px]", children: assignableRoles.map((role) => (_jsx("button", { type: "button", onClick: () => onChangeRole(role), className: `rounded-[6px] px-[8px] py-[4px] text-[12px] ${resolveAuthorRole(member) === role
                                        ? "bg-[var(--adaptive-blue50)] font-semibold text-[var(--adaptive-blue500)]"
                                        : "text-[var(--adaptive-black800)] hover:bg-[var(--adaptive-black100)]"}`, children: roleLabelFor(role, roleMessages) }, role))) })] })) : null, _jsxs("div", { className: "flex flex-wrap gap-[6px]", children: [!apiMode && onToggleActive ? (_jsx("button", { type: "button", onClick: onToggleActive, className: "rounded-[6px] px-[8px] py-[4px] text-[12px] text-[var(--adaptive-black800)] hover:bg-[var(--adaptive-black100)]", children: inactive ? activateLabel : deactivateLabel })) : null, apiMode && onDelete ? (_jsx("button", { type: "button", onClick: onDelete, className: "rounded-[6px] px-[8px] py-[4px] text-[12px] font-semibold text-[var(--adaptive-red500)] hover:bg-[color-mix(in_srgb,var(--adaptive-red500)_10%,transparent)]", children: deleteLabel })) : null] })] })) : null] }));
}
export function PanelTeamSettings() {
    const { messages, teamReviewers, teamActor, canAccessTeamSettings, persistenceStatus, apiTeamDirectory, apiTeamMembersLoading, refreshTeamMembers, onListReviewerRequests, onResolveReviewerRequest, onRegisterReviewer, onUpdateReviewer, onDeleteReviewer, } = useReportPreferences();
    ...
    const handleJoinMember = async (member) => {
        if (!onRegisterReviewer) {
            return;
        }
        if (!canAssignTeamRole(teamActor, apiRole)) {
    ...
    return (_jsxs("div", { className: "flex flex-col", children: [_jsxs("div", { className: "border-b border-[var(--adaptive-border-subtle)] px-[12px] py-[10px]", children: [_jsxs("p", { className: "inline-flex items-center gap-[6px] text-[12px] leading-[1.5] text-[var(--adaptive-black600)]", children: [modeHint, teamManageLock.locked ? (_jsx(HoverTooltip, { label: teamManageLock.tooltipLabel, multiline: true, children: _jsx("span", { className: "inline-flex text-[var(--adaptive-black500)]", children: _jsx(LockIcon, { className: "h-[12px] w-[12px]" }) }) })) : null] }), _jsx("p", { className: "mt-[6px] text-[12px] font-semibold text-[var(--adaptive-black700)]", children: memberCountLabel })] }), _jsxs("section", { className: "flex flex-col border-b border-[var(--adaptive-border-subtle)]", children: [_jsx("p", { className: "px-[12px] pt-[10px] pb-[4px] text-[12px] font-semibold uppercase tracking-[0.02em] text-[var(--adaptive-black500)]", children: team.sectionMembers }), loading ? _jsx("p", { className: "px-[12px] py-[10px] text-[12px] text-[var(--adaptive-black600)]", children: team.loading }) : null, !loading && members.length === 0 ? (_jsx(NoticeDialog, { role: "status", title: team.emptyMembers })) : null, members.map((member) => {
                        ...
                        return (_jsx(MemberRow, { member: member, roleLabel: roleLabelFor(resolveAuthorRole(member), team), roleMessages: team, inactiveLabel: team.inactive, canEdit: editable, canJoin: joinable, apiMode: writeEnabled, assignableRoles: assignableRoles, editRoleLabel: team.editRole, activateLabel: team.activate, deactivateLabel: team.deactivate, deleteLabel: team.deleteMember, joinLabel: team.join, onChangeRole: editable ? (role) => void handleUpdate(member, { role }) : undefined, onToggleActive: editable && !writeEnabled ? () => void handleUpdate(member, { is_active: member.isActive === false }) : undefined, onDelete: deletable ? () => void handleDelete(member) : undefined, onJoin: joinable ? () => void handleJoinMember(member) : undefined }, member.id));
                    })] }), localManageMode ? (_jsxs(_Fragment, { children: [_jsxs("section", { className: "flex flex-col border-b border-[var(--adaptive-border-subtle)]", children: [_jsx("p", { className: "px-[12px] pt-[10px] pb-[4px] text-[12px] font-semibold uppercase tracking-[0.02em] text-[var(--adaptive-black500)]", children: team.sectionRequests }), assignableRoles.length > 0 ? (_jsxs("div", { className: "flex flex-wrap gap-[6px] px-[12px] pb-[8px]", children: [_jsx("p", { className: "w-full text-[12px] text-[var(--adaptive-black600)]", children: team.approveAsRole }), assignableRoles.map((role) => (_jsx("button", { type: "button", onClick: () => setApproveRole(role), className: `rounded-[6px] px-[8px] py-[4px] text-[12px] ${approveRole === role
                                            ? "bg-[var(--adaptive-blue50)] font-semibold text-[var(--adaptive-blue500)]"
                                            : "text-[var(--adaptive-black800)] hover:bg-[var(--adaptive-black100)]"}`, children: roleLabelFor(role, team) }, role)))] })) : null, pendingRequests.length === 0 ? (_jsx(NoticeDialog, { role: "status", title: team.emptyRequests })) : (pendingRequests.map((request) => (_jsxs("div", { className: "flex flex-col gap-[8px] border-b border-[var(--adaptive-border-subtle)] px-[12px] py-[10px] last:border-b-0", children: [_jsxs("div", { children: [_jsx("p", { className: "text-[14px] font-semibold text-[var(--adaptive-black900)]", children: request.author_name }), _jsx("p", { className: "truncate text-[12px] text-[var(--adaptive-black600)]", children: request.author_id }), _jsx("p", { className: "mt-[4px] break-all text-[12px] text-[var(--adaptive-black500)]", children: request.public_key })] }), _jsxs("div", { className: "flex gap-[6px]", children: [_jsx("button", { type: "button", disabled: busyId === request.id, onClick: () => void handleResolve(request.id, "approved"), className: "rounded-[6px] bg-[var(--adaptive-blue50)] px-[8px] py-[4px] text-[12px] font-semibold text-[var(--adaptive-blue500)] disabled:opacity-50", children: team.approve }), _jsx("button", { type: "button", disabled: busyId === request.id, onClick: () => void handleResolve(request.id, "rejected"), className: "rounded-[6px] px-[8px] py-[4px] text-[12px] text-[var(--adaptive-black800)] hover:bg-[var(--adaptive-black100)] disabled:opacity-50", children: team.reject })] })] }, request.id))))] }), onRegisterReviewer && assignableRoles.length > 0 ? (_jsxs("section", { className: "flex flex-col px-[12px] py-[10px]", children: [_jsx("p", { className: "mb-[6px] text-[12px] font-semibold uppercase tracking-[0.02em] text-[var(--adaptive-black500)]", children: team.sectionManual }), _jsx("div", { className: "mb-[8px] flex flex-wrap gap-[6px]", children: assignableRoles.map((role) => (_jsx("button", { type: "button", onClick: () => setManualRole(role), className: `rounded-[6px] px-[8px] py-[4px] text-[12px] ${manualRole === role
                                        ? "bg-[var(--adaptive-blue50)] font-semibold text-[var(--adaptive-blue500)]"
                                        : "text-[var(--adaptive-black800)] hover:bg-[var(--adaptive-black100)]"}`, children: roleLabelFor(role, team) }, role))) }), _jsxs("div", { className: "flex flex-col gap-[6px]", children: [_jsx("input", { value: manualName, onChange: (event) => setManualName(event.target.value), placeholder: team.manualNamePlaceholder, className: "rounded-[8px] border border-[var(--adaptive-black200)] bg-[var(--adaptive-black50)] px-[10px] py-[8px] text-[12px] text-[var(--adaptive-black900)] outline-none" }), _jsx("input", { value: manualId, onChange: (event) => setManualId(event.target.value), placeholder: team.manualIdPlaceholder, className: "rounded-[8px] border border-[var(--adaptive-black200)] bg-[var(--adaptive-black50)] px-[10px] py-[8px] text-[12px] text-[var(--adaptive-black900)] outline-none" }), _jsx("textarea", { value: manualPublicKey, onChange: (event) => setManualPublicKey(event.target.value), placeholder: team.manualPublicKeyPlaceholder, rows: 3, className: "rounded-[8px] border border-[var(--adaptive-black200)] bg-[var(--adaptive-black50)] px-[10px] py-[8px] text-[12px] text-[var(--adaptive-black900)] outline-none" }), _jsx("button", { type: "button", disabled: busyId === "register", onClick: () => void handleLocalRegister(), className: "w-full rounded-[8px] px-[12px] py-[8px] text-left text-[14px] text-[var(--adaptive-black800)] hover:bg-[var(--adaptive-black100)] disabled:opacity-50", children: team.register })] })] })) : null] })) : null, canManage && writeEnabled && onRegisterReviewer && assignableRoles.length > 0 ? (_jsxs("section", { className: "flex flex-col px-[12px] py-[10px]", children: [_jsx("p", { className: "mb-[6px] text-[12px] font-semibold uppercase tracking-[0.02em] text-[var(--adaptive-black500)]", children: team.sectionRegister }), _jsx("div", { className: "mb-[8px] flex flex-wrap gap-[6px]", children: assignableRoles.map((role) => (_jsx("button", { type: "button", onClick: () => setApiRole(role), className: `rounded-[6px] px-[8px] py-[4px] text-[12px] ${apiRole === role
                                ? "bg-[var(--adaptive-blue50)] font-semibold text-[var(--adaptive-blue500)]"
                                : "text-[var(--adaptive-black800)] hover:bg-[var(--adaptive-black100)]"}`, children: roleLabelFor(role, team) }, role))) }), _jsxs("div", { className: "flex flex-col gap-[6px]", children: [_jsx("input", { value: apiUserId, onChange: (event) => setApiUserId(event.target.value), placeholder: team.apiUserIdPlaceholder, className: "rounded-[8px] border border-[var(--adaptive-black200)] bg-[var(--adaptive-black50)] px-[10px] py-[8px] text-[12px] text-[var(--adaptive-black900)] outline-none" }), _jsx("button", { type: "button", disabled: busyId === "register", onClick: () => void handleApiRegister(), className: "w-full rounded-[8px] px-[12px] py-[8px] text-left text-[14px] text-[var(--adaptive-black800)] hover:bg-[var(--adaptive-black100)] disabled:opacity-50", children: team.register })] })] })) : null] }));
}
