...
export function ReportPersonalKeyDialog({ mode, onCancel, onComplete }) {
    ...
    if (mode === "required") {
        ...
        body = _jsx("p", { className: "rounded-[8px] bg-amber-50 p-[10px] text-[12px] leading-[1.5] text-amber-800", children: messages.personalKey.rotateWarning });
    }
    return (_jsxs(NoticeDialog, { title: title, description: description, actions: [
            {
                id: "cancel",
