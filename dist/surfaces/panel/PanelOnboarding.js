...
import { MARKER_FILL_STYLE_VALUES } from "../../shared/constants/markerAppearance.js";
import { PANEL_ROLE_VALUES } from "../../shared/constants/panelRole.js";
import { hasStoredLocalePreference } from "../../shared/hooks/useLocalePreference.js";
import { useReportPreferences, useReportSession } from "../../shared/providers/reportContext.js";
import { getDefaultVisibleTabsForRole } from "../../shared/utils/panel/panelTabPreference.js";
import { ReportAuthError, resolveRegistrationError } from "../../shared/utils/auth/reportAuthError.js";
import { isPersonalKeyFile, readPersonalKeyFile } from "../../shared/utils/feedback/feedbackDataTransfer.js";
import { hasTeamRequestHandler, isTeamWriteEnabled } from "../../shared/utils/report/teamManagement.js";
...
import { DropdownMenuItem } from "../../shared/components/ui/DropdownMenu.js";
...
export function PanelOnboarding() {
    ...
    const registerErrorMessage = registerErrorKind === "account-already-exists" ? onboarding.registerDuplicate : registerErrorKind === "invalid-registration" ? onboarding.registerInvalid : onboarding.registerUnknownError;
