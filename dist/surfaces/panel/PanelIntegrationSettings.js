...
export function PanelIntegrationSettings() {
    ...
    if (!adapterIntegrationStatus) {
        return _jsx("section", { className: "px-[12px] py-[12px] text-[14px] text-[var(--adaptive-black700)]", children: messages.settings.integrationLocalModeHint });
    }
