...
import { getExperimentalUserTabs, getPanelTabDefinition, getStableUserTabs, } from "../../shared/constants/panelTabRegistry.js";
import { isTabRecommendedForRole, moveVisibleTab } from "../../shared/utils/panel/panelTabPreference.js";
...
export function PanelTabSelector({ role, selectedTabs, context, messages, onChange }) {
    ...
    return (_jsxs("section", { className: "flex flex-col gap-[12px]", children: [_jsxs("div", { className: "flex flex-col gap-[6px]", children: [_jsxs("div", { children: [_jsx("p", { className: "text-[12px] font-[600] text-[var(--adaptive-black500)]", children: panelMessages.tabsSectionLabel }), _jsx("p", { className: "mt-[2px] text-[12px] text-[var(--adaptive-black500)]", children: panelMessages.tabsOrderHint })] }), _jsx(TabRows, { tabs: stableTabs, role: role, selectedTabs: selectedTabs, messages: messages, onToggle: toggleTab, onMove: moveTab })] }), experimentalTabs.length > 0 ? (_jsxs("div", { className: "flex flex-col gap-[6px]", children: [_jsx("p", { className: "text-[12px] font-[600] text-[var(--adaptive-black500)]", children: panelMessages.tabsExperimentalSectionLabel }), _jsx(TabRows, { tabs: experimentalTabs, role: role, selectedTabs: selectedTabs, messages: messages, onToggle: toggleTab, onMove: moveTab })] })) : null] }));
}
