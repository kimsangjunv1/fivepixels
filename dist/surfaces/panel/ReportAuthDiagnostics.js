...
import { useReportPreferences, useReportData } from "../../shared/providers/reportContext.js";
const FIELD_LABELS = {
    projectId: "projectId",
...
export function ReportAuthDiagnostics() {
    ...
    return (_jsxs("section", { className: "flex min-h-0 flex-1 flex-col overflow-y-auto bg-[var(--adaptive-fillOpacity500)]", children: [_jsxs("div", { className: "flex items-center justify-between gap-[8px]", children: [_jsx("h6", { className: "text-[14px] font-bold text-[var(--adaptive-black900)]", children: diagnostics.title }), _jsx("span", { className: `rounded-full px-[8px] py-[2px] text-[12px] font-semibold ${authDiagnostics.status === "matched"
