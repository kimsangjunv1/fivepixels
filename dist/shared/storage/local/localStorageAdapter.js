...
import { getReportsStorageKey } from "../../../shared/constants/storageKeys.js";
import { parseFeedbackStorageEnvelope, serializeFeedbackStorageEnvelope } from "../../../shared/utils/feedback/feedbackTransferSchema.js";
import { allocateNextFcNumber, backfillFcNumbers } from "../../../shared/utils/feedback/feedbackCaseId.js";
import { paginateSortedReplies, sortRepliesChronologically } from "../../../shared/utils/feedback/replyHistory.js";
import { applyCaseStatusSync, normalizeFeedbackCases, normalizeReplyCaseIds, } from "../../../shared/utils/report/reportCases.js";
import { normalizeReportPosition } from "../../../shared/utils/report/reportPosition.js";
function createId() {
        ...
        return [
            {
                ...
                ...(Array.isArray(reply.user_mentions) && reply.user_mentions.length > 0 ? { user_mentions: reply.user_mentions } : {}),
            },
        ];
    });
}
    ...
    return {
        ...
        async createReply(commentId, payload) {
            ...
            const reply = {
                ...
                ...(payload.user_mentions && payload.user_mentions.length > 0 ? { user_mentions: payload.user_mentions } : {}),
            };
