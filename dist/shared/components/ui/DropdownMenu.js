...
import { MenuTooltipItem, MenuTooltipSurface } from "../../../surfaces/tooltip/MenuTooltip.js";
const MENU_GAP = 0;
// const MENU_GAP = 6;
 ...
 */
export function DropdownMenu({ open, onClose, trigger, children, menuClassName, align = "right", }) {
...
export function DropdownMenuItem({ onClick, active = false, disabled = false, danger = false, icon, children, className = "", }) {
