...
import { getAuthorIdFromPrivateKey, getAuthorNameFromPrivateKey, hasStoredPersonalKey, parsePrivateKeyBundle, publicKeysMatch, serializePublicKey, } from "../../../shared/utils/auth/personalKey.js";
import { clearRemoteAuthSession, readRemoteAuthSession, saveLoginMethod, saveRemoteAuthSession, } from "../../../shared/utils/auth/loginSession.js";
import { applyRefreshUser, invokeOptionalLogout, resolveRefreshSessionMethod, resolveRemoteOnboardingCompleted } from "../../../shared/utils/auth/remoteAuthLifecycle.js";
import { ReportAuthError } from "../../../shared/utils/auth/reportAuthError.js";
import { resolvePanelView } from "../../../shared/utils/auth/resolvePanelView.js";
import { buildPresentationViewers, resolveSessionActor } from "../../../shared/utils/report/reportTeam.js";
export function useReportAuthSession({ projectId, environment, authors, identify, requireReviewerKey, pixelsMode, sync: syncProp, requireAuth: requireAuthProp, onApiLogin, onApiRegister, onApiLogout, onApiRefresh, onArtemisLogin, }) {
    ...
    const { personalKey, publicKey, personalKeyRequired: personalKeyRequiredFromKey, personalKeyPendingRegistration, personalKeyCandidates, authorizedAuthors: personalKeyAuthorizedAuthors, issuePersonalKey, issueSelfKey, rotatePersonalKey, insertPersonalKey, clearPersonalKey, signPayload, } = usePersonalKey({
    ...
    const panelView = useMemo(() => resolvePanelView({
        isPresentationMode,
        requiresReviewerKey,
        loginMethod,
        requireAuth,
    ...
    const registerWithApi = useCallback(async (payload) => {
        if (!onApiRegister) {
