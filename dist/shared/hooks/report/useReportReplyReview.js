...
import { canShowCaseClaimAction, createReplyStatusForSubmit, getLatestBranchRootForCase, resolveDenyComposerType, getReportReplies, ISSUE_ROOT_PARENT_ID, requiresCaseActorPermissionForComposer, resolveOriginalFeedbackAuthorName, resolveParentReplyIdForCaseQuestion, } from "../../../shared/utils/feedback/feedbackThread.js";
import { claimCaseAssignee, buildResolvedCasesUpdate, canActOnCase, canEditReportCases, createReportCase, getCaseAssigneeName, getReportCases, isValidFocusedCase, resolveDefaultFocusedCaseId, syncIssueStatusFromCases, transferCaseAssignee, } from "../../../shared/utils/report/reportCases.js";
import { createReplyId } from "../../../shared/utils/shared/format.js";
import { notifyFeedbackReply, notifyFeedbackUpdate } from "../../../shared/utils/report/reportCallbacks.js";
