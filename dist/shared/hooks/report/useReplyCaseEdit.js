...
import { getFieldError } from "../../../shared/utils/report/fields.js";
import { canEditReportCases, createReportCase, getReportCases, resolveDefaultFocusedCaseId, syncIssueStatusFromCases } from "../../../shared/utils/report/reportCases.js";
import { notifyFeedbackUpdate } from "../../../shared/utils/report/reportCallbacks.js";
...
export function useReplyCaseEdit({ reports, activeReplyReport, activeReplyReportId, focusedCaseId, selectCase, sessionActor, fields, messages, updateFeedback, signUpdatePayload, eventCallbacks, setErrorMessage, }) {
    ...
    const updateCaseEditDraftCase = useCallback((caseId, text, mentions, userMentions) => {
