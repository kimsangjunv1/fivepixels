...
import { getLatestReply } from "../../shared/utils/feedback/feedbackThread.js";
...
import { adapterUsesCreateReply, adapterUsesLazyCases, adapterUsesLazyReplies, hydrateFeedbackFromAdapter, } from "../../shared/utils/adapter/resolveAdapter.js";
...
export function useReportPersistence({ projectId, environment, appVersion, sync = "local", fields, adapter, routeKey, fetchEnabled = true, listFetchEnabled = true, allReportsFetchEnabled = false, replyHistory, }) {
    ...
    const refreshReportsAfterMutation = useCallback((options) => {
