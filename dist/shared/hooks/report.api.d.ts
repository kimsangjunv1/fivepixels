import type { CreateReportFeedbackPayload, CreateReplyPayload, ListRepliesParams, ListRepliesResult, ReportFeedback, ReportListAllParams, ReportListAllResult, ReportReply, ReportStorageAdapter, UpdateReportFeedbackPayload } from "../../shared/types/report.js";
...
export declare function listReplies(adapter: ReportStorageAdapter, commentId: string, params?: ListRepliesParams): Promise<ListRepliesResult>;
