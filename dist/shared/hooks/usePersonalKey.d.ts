import type { ReportAuthAction, ReportAuthor, ReportIdentify } from "../../shared/types/report.js";
...
export declare function usePersonalKey({ enabled, requireKey, projectId, environment, identify, authors }: UsePersonalKeyOptions): {
    ...
    signPayload: (action: ReportAuthAction, payload: unknown) => Promise<import("../../shared/types/report.js").ReportAuthProof | null>;
};
export {};
