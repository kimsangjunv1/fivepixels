...
import { FIVEPIXELS_HOST_ID, OVERLAY_HOST_YIELD_DELAY_MS, OVERLAY_HOST_YIELD_HOLD_MS } from "../../shared/constants/overlayChrome.js";
function getMountElement() {
    if (typeof document === "undefined") {
        return null;
    }
    const host = document.getElementById(FIVEPIXELS_HOST_ID);
    return host?.shadowRoot?.querySelector("[data-fivepixels-mount]");
}
function isFivepixelsPointerTarget(target) {
 ...
 */
export function useOverlayChrome({ mode }) {
...
//# sourceMappingURL=useOverlayChrome.js.map