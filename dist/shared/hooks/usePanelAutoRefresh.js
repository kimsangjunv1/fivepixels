...
import { DEFAULT_PANEL_AUTO_REFRESH_INTERVAL_MINUTES, isPanelAutoRefreshIntervalMinutes, PANEL_AUTO_REFRESH_STORAGE_KEY, } from "../../shared/constants/panelAutoRefresh.js";
import { formatPanelAutoRefreshCountdown, isPanelAutoRefreshCycleDue, resolvePanelAutoRefreshProgress, resolvePanelAutoRefreshRemainingMs, resolvePanelAutoRefreshVisibilityAction, } from "../../shared/utils/panel/panelAutoRefresh.js";
...
function persistInterval(intervalMinutes) {
    try {
...
export function usePanelAutoRefresh({ refetch, isFetching }) {
    const [intervalMinutes, setIntervalMinutesState] = useState(readStoredInterval);
    ...
    const beginCycle = useCallback((at = Date.now()) => {
        ...
        setProgress(0);
        setRemainingMs(intervalMinutesRef.current > 0 ? intervalMinutesRef.current * 60000 : 0);
    }, []);
    ...
    const setIntervalMinutes = useCallback((next) => {
    ...
    useEffect(() => {
        ...
        const handleVisibilityChange = () => {
            ...
            const startedAt = cycleStartedAtRef.current;
            const currentIntervalMs = intervalMinutesRef.current * 60000;
...
//# sourceMappingURL=usePanelAutoRefresh.js.map