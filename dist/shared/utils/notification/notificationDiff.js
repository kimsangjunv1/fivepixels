...
function mentionsActor(userMentions, actor) {
...
function isAssignedTo(caseItem, actor) {
...
function pushUnique(items, next, seen) {
    if (seen.has(next.id)) {
        return;
    }
    seen.add(next.id);
...
export function diffNotifications(args) {
    ...
    for (const entry of current) {
        ...
        for (const caseItem of cases) {
            ...
            if (mentionsActor(caseItem.user_mentions, actor) &&
...
//# sourceMappingURL=notificationDiff.js.map