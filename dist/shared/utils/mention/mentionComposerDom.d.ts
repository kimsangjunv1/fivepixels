...
export declare const USER_MENTION_CHIP_CLASS = "mx-[1px] inline-flex items-center rounded-[6px] bg-[color-mix(in_srgb,var(--adaptive-accent-coral)_14%,transparent)] px-[6px] py-[4px] text-[12px] font-semibold text-[var(--adaptive-accent-coral)] align-baseline";
 ...
 */
export declare function serializeMentionEditor(root: HTMLElement, mentions: ElementMention[], userMentions?: UserMention[]): MentionEditorState;
/** Same rules as full serialize, but only content before the current caret. */
export declare function serializeMentionEditorBeforeCaret(root: HTMLElement, mentions: ElementMention[], caret: EditorCaretPoint | null, userMentions?: UserMention[]): MentionEditorState | null;
...
export declare function renderMentionEditorContent(root: HTMLElement, message: string, mentions: ElementMention[], userMentions?: UserMention[], chipClassName?: string, userChipClassName?: string): void;
...
export declare function deleteMentionChipBeforeCaret(editor: HTMLElement, mentions: ElementMention[], userMentions?: UserMention[]): MentionEditorState | null;
