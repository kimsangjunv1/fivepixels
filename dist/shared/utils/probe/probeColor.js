...
export function isValidProbeHexColor(value) {
    return PROBE_HEX_COLOR_PATTERN.test(value.trim());
}
export function sanitizeProbeHexInput(raw) {
    if (!raw.trim()) {
        return "";
    }
...
export function getProbeColorPreview(value) {
    return isValidProbeHexColor(value) ? value.trim().toLowerCase() : null;
}
export function probeHexToColorInputValue(value) {
...
export function cssColorToProbeHex(color) {
