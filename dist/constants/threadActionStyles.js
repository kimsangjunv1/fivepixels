export const THREAD_ACTION_STYLE = {
    ask: {
        color: "#10B981",
...
export function getThreadActionButtonClass(kind, active) {
...
export function resolveComposerModeActionKind(mode) {
    if (mode === "question") {
        return "ask";
    }
...
//# sourceMappingURL=threadActionStyles.js.map