...
export function ReportProvider({ project, ui, visibility, team, mode = "default", sync = "local", adapter, fields, onNavigate, onRevealTarget, onEvent, onReply, github, children, }) {
    ...
    return (_jsx(ReportProviderEnabled, { projectId: resolvedProject.projectId, environment: resolvedProject.environment, appVersion: resolvedProject.appVersion, panelAppearance: resolvedUi.panelAppearance, tooltipAppearance: resolvedUi.tooltipAppearance, showFeedbackList: resolvedUi.showFeedbackList, visibleShortcutKeys: resolvedUi.visibleShortcutKeys, questionThreadDefault: resolvedUi.questionThreadDefault, replyHistory: resolvedUi.replyHistory, shortcut: resolvedUi.shortcut, fields: resolvedFields, authors: resolvedTeam.reviewers, requireReviewerKey: resolvedTeam.requireReviewerKey, identify: resolvedTeam.user, adapter: adapter, onNavigate: onNavigate, onRevealTarget: onRevealTarget, onEvent: onEvent, onReply: onReply, github: github, routeKey: resolvedVisibility.routeKey, locale: resolvedUi.locale, messageOverrides: ui?.messages, pixelsMode: mode, sync: sync, children: children }));
}
