...
export function InspectTooltip({ target }) {
    ...
    return (_jsxs(StyleInspectTooltip, { open: true, pointer: hoverPointer, children: [_jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipTag, value: `<${tagName}>` }), _jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipSize, value: sizeLabel }), target.boxStyle ? (_jsxs(_Fragment, { children: [_jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipDisplay, value: target.boxStyle.display }), _jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipPadding, value: target.boxStyle.padding }), _jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipMargin, value: target.boxStyle.margin })] })) : null, target.fontStyle ? (_jsxs(_Fragment, { children: [_jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipFontFamily, value: target.fontStyle.fontFamily }), _jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipFontSize, value: target.fontStyle.fontSize }), _jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipFontWeight, value: target.fontStyle.fontWeight }), _jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipLineHeight, value: target.fontStyle.lineHeight })] })) : null, _jsxs("div", { className: "flex flex-col gap-[6px] border-t border-[var(--adaptive-border-subtle)] pt-[8px] mt-[8px]", children: [target.fpOpenAttribute ? (_jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipFpOpen, value: target.fpOpenAttribute })) : null, target.fpViewAttribute ? (_jsx(StyleInspectTooltipRow, { label: messages.pickTarget.tooltipFpView, value: target.fpViewAttribute })) : null, _jsxs("div", { className: "flex items-start justify-between gap-[8px] text-[14px]", children: [_jsx("span", { className: "shrink-0 text-[var(--adaptive-black500)]", children: messages.pickTarget.tooltipReportId }), _jsxs("div", { className: "flex min-w-0 items-start justify-end gap-[6px]", children: [_jsx(ReportIdStatusIcon, { tagged: target.isTagged }), _jsx("span", { className: "min-w-0 break-all text-right font-[var(--coding-font)] text-[var(--adaptive-black700)]", children: reportIdValue })] })] })] })] }));
}
//# sourceMappingURL=InspectTooltip.js.map