...
import { DeviceFrameArtwork } from "../preview/DeviceFrameArtwork.js";
import { DevicePreviewQrPanel } from "../preview/DevicePreviewQrPanel.js";
import { DeviceStatusBar, getDeviceStatusBarHeight } from "../preview/DeviceStatusBar.js";
import { CapturePanel } from "../preview/CapturePanel.js";
import { MinimizedDockSimpleSubtitleRow, MinimizedDockWindowChrome } from "../window/MinimizedDockWindowChrome.js";
import { WINDOW_HEADER_BUTTON_CLASS, WindowModeControls } from "../window/WindowModeControls.js";
...
import { buildDevicePreviewCaptureFilename, captureDevicePreview, defaultRasterizeElement, downloadCanvasPng, getDevicePreviewCaptureLayout, resolveCaptureViewportScroll, } from "../preview/devicePreviewCapture.js";
import { MINIMIZED_WINDOW_HEIGHT } from "../utils/overlay/minimizedDockLayout.js";
import { resolveMobilePreviewChrome, resolveMobilePreviewFrameMetrics, resolveMobilePreviewLayout, resolveMobilePreviewScreenRadius, resolveMobilePreviewScreenSize, resolveMobilePreviewStatusBarReferenceWidth, } from "../preview/mobilePreviewLayout.js";
import { MOBILE_PREVIEW_FRAME_NAME, getMobilePreviewCaptureRoot, getMobilePreviewGuestDocument, getMobilePreviewGuestWindow, isInsideMobilePreviewFrame, isMobilePreviewGuestDocumentReady, syncMobilePreviewGuestViewport, } from "../preview/mobilePreviewFrame.js";
import { normalizeMobilePreviewUrl, persistMobilePreviewUrl, readMobilePreviewUrl } from "../preview/mobilePreviewUrl.js";
import { MOBILE_PREVIEW_SIDE_PANEL_GAP, MOBILE_PREVIEW_SIDE_PANEL_STACK_GAP, MOBILE_PREVIEW_SIDE_PANEL_WIDTH, isMobilePreviewSidePanelOpen, toggleMobilePreviewSidePanel, } from "../preview/mobilePreviewSidePanels.js";
...
export function MobilePreviewWindow() {
    ...
    const [captureCornerStyle, setCaptureCornerStyle] = useState("rounded");
    ...
    return (_jsx("div", { ref: rootRef, "data-fivepixels-interactive": "", "data-chrome": "mobile-preview-simulator", "data-mode": windowMode, "data-orientation": mobilePreviewOrientation, className: `fixed select-none ${showMinimizedChrome ? "" : "flex flex-col items-start"}`, style: {
            ...
            ...(isDockDragging ? { transform: "scale(1.03)", willChange: "left, top, transform" } : null),
                        ...
                        height: frameHeight,
                                ...
                                if (panelId === "capture") {
                                    return (_jsx(CapturePanel, { captureState: captureState, captureImageEnabled: captureImageEnabled, captureStatusBarEnabled: captureStatusBarEnabled, captureCornerStyle: captureCornerStyle, onCaptureImageEnabledChange: setCaptureImageEnabled, onCaptureStatusBarEnabledChange: setCaptureStatusBarEnabled, onCaptureCornerStyleChange: setCaptureCornerStyle, onCapture: () => void handleCapture(), width: MOBILE_PREVIEW_SIDE_PANEL_WIDTH }, panelId));
                                }
                                if (panelId === "qr") {
...
//# sourceMappingURL=MobilePreviewWindow.js.map