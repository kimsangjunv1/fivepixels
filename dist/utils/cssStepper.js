...
export function parseCssPixel(value, fallback = 0) {
...
export function formatCssPixel(value) {
    return `${Math.max(0, Math.round(value * 10) / 10)}px`;
}
export function stepCssPixel(value, delta, fallback = 16) {
    return formatCssPixel(parseCssPixel(value, fallback) + delta);
}
export function stepCssBoxSides(value, delta) {
    if (!value.trim()) {
...
export function isSteppableCssValue(value) {
