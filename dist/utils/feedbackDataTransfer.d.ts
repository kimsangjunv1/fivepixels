...
export declare function getFeedbackStorageKey({ projectId, environment }: FeedbackTransferScope): string;
export declare function readAllFeedback({ projectId, environment }: FeedbackTransferScope): ReportFeedback[];
...
export declare function createFeedbackBackupFilename(projectId: string, environment?: string): string;
