 ...
 */
export declare function resolveFivePixelsRequire({ sync, require: requireProp, requireAuth, teamRequireReviewerKey, }: ResolveFivePixelsRequireOptions): ResolvedFivePixelsRequire;
//# sourceMappingURL=resolveRequire.d.ts.map