...
export function ReportView() {
    ...
    return (_jsxs(ShadowReportRoot, { tooltipAppearance: resolvedTooltipAppearance, children: [showHostDevicePreview ? (_jsx(ThemeScope, { appearance: resolvedPanelAppearance, children: _jsx(DevicePreview, {}) })) : null, _jsx(ThemeScope, { appearance: resolvedPanelAppearance, className: "pointer-events-none fixed inset-0 z-[999998]", children: _jsx(DotWaveOverlay, { active: mode === "report", color: resolvedFeedbackModeDotColor }) }), _jsx(ThemeScope, { appearance: resolvedPanelAppearance, children: _jsx(Panel, {}) }), showMobilePreviewWindow ? (_jsx(ThemeScope, { appearance: resolvedPanelAppearance, children: _jsx(MobilePreviewWindow, {}) })) : null, notificationUiOpen ? (_jsx(ThemeScope, { appearance: resolvedPanelAppearance, children: _jsx(NotificationCenter, {}) })) : null, showOverlay ? (_jsx(ThemeScope, { appearance: resolvedTooltipAppearance, children: _jsxs(TooltipLayer, { children: [mode !== "idle" ? (_jsxs(_Fragment, { children: [_jsx(MarkerLayer, {}), _jsx(DraftMarker, {}), _jsx(DraftTooltip, {})] })) : null, _jsx(WindowLayer, {})] }) })) : null] }));
}
