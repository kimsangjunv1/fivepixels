...
export function FivePixels({ project, ui, visibility, team, mode = "default", sync = "local", require: requireProp, requireAuth, adapter, fields = DEFAULT_FIELDS, onNavigate, onEvent, onReply, github, networkMonitor, }) {
    ...
    return (_jsx(ReportProvider, { project: project, ui: ui, visibility: visibility, team: team, mode: mode, sync: sync, require: requireProp, requireAuth: requireAuth, adapter: adapter, fields: fields, onNavigate: onNavigate, onEvent: onEvent, onReply: onReply, github: github, networkMonitor: networkMonitor, children: _jsx(ReportView, {}) }));
}
