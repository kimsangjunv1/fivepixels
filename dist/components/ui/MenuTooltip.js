...
const MENU_TOOLTIP_ITEM_CLASS = "flex w-full items-center gap-[8px] rounded-[8px] px-[2px] py-[6px] text-left text-[14px] font-medium leading-[1.45] text-[var(--adaptive-black900)] hover:bg-[var(--adaptive-black100)] disabled:cursor-not-allowed disabled:opacity-50";
