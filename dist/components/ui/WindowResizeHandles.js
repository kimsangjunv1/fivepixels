...
export function WindowResizeHandles({ inactive = false, resizeWidthAriaLabel, resizeHeightAriaLabel, createResizePointerDown }) {
    ...
    return (_jsx(_Fragment, { children: ALL_WINDOW_RESIZE_EDGES.map((edge) => (_jsx(PanelResizeHandle, { edge: edge, ariaLabel: ariaLabels[EDGE_ARIA_LABEL_KEY[edge]], inactive: inactive, onPointerDown: createResizePointerDown({ kind: "edge", edge }) }, edge))) }));
}
