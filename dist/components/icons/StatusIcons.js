...
const CHECK_CIRCLE_PATH = "m424-408-86-86q-11-11-28-11t-28 11q-11 11-11 28t11 28l114 114q12 12 28 12t28-12l226-226q11-11 11-28t-11-28q-11-11-28-11t-28 11L424-408Zm56 328q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Z";
...
function StatusGlyph({ path, className, fill }) {
    return (_jsx(MaterialIcon, { className: className, fill: fill, children: _jsx("path", { d: path }) }));
}
export function WaitStatusIcon(props) {
    return (_jsx(StatusGlyph, { path: SCHEDULE_PATH, ...props }));
}
export function RouteWaitStatusIcon(props) {
    return (_jsx(StatusGlyph, { path: FLAG_PATH, ...props }));
}
export function SuggestedStatusIcon(props) {
    return (_jsx(StatusGlyph, { path: AUTORENEW_PATH, ...props }));
}
export function GitIssuedStatusIcon(props) {
    return (_jsx(StatusGlyph, { path: ADD_PATH, ...props }));
}
export function ResolvedStatusIcon(props) {
    return (_jsx(StatusGlyph, { path: CHECK_CIRCLE_PATH, ...props }));
}
export function FoundErrorStatusIcon(props) {
    return (_jsx(StatusGlyph, { path: REMOVE_PATH, ...props }));
}
export function FeedbackStatusIcon({ status, className, fill }) {
    if (status === "resolved") {
        return (_jsx(ResolvedStatusIcon, { className: className, fill: fill }));
    }
    if (status === "found_error") {
        return (_jsx(FoundErrorStatusIcon, { className: className, fill: fill }));
    }
    if (status === "git_issued") {
        return (_jsx(GitIssuedStatusIcon, { className: className, fill: fill }));
    }
...
export function RouteDetailStatusIcon({ status, className, fill }) {
    if (status === "wait") {
        return (_jsx(RouteWaitStatusIcon, { className: className, fill: fill }));
    }
    if (status === "suggested") {
        return (_jsx(SuggestedStatusIcon, { className: className, fill: fill }));
    }
