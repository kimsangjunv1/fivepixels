...
export function DotWaveOverlay({ active = true, dotSize = 2, gap = 12, 
// gap = 20,
minOpacity = 0.2, maxOpacity = 1, waveDuration = 1400, fadeOutDuration = 2200, deactivateDelay = 0, color = "#94a3b8", origin = DEFAULT_ORIGIN, className = "", style, }) {
