...
export declare function MobilePreviewCaptureWindow({ captureState, captureScale, captureImageEnabled, captureStatusBarEnabled, onCaptureScaleChange, onCaptureImageEnabledChange, onCaptureStatusBarEnabledChange, onCapture, onClose, }: MobilePreviewCaptureWindowProps): import("react").JSX.Element;
