...
export function PickTargetHoverTooltip({ target }) {
    ...
    return (_jsx("div", { ref: tooltipRef, className: TOOLTIP_SURFACE_CLASS, style: {
        ...
        }, children: _jsxs("div", { className: "flex flex-col gap-[6px]", children: [_jsx(InspectRow, { label: messages.pickTarget.tooltipTag, value: `<${tagName}>` }), _jsx(InspectRow, { label: messages.pickTarget.tooltipSize, value: sizeLabel }), target.boxStyle ? (_jsxs(_Fragment, { children: [_jsx(InspectRow, { label: messages.pickTarget.tooltipDisplay, value: target.boxStyle.display }), _jsx(InspectRow, { label: messages.pickTarget.tooltipPadding, value: target.boxStyle.padding }), _jsx(InspectRow, { label: messages.pickTarget.tooltipMargin, value: target.boxStyle.margin })] })) : null, target.fontStyle ? (_jsxs(_Fragment, { children: [_jsx(InspectRow, { label: messages.pickTarget.tooltipFontFamily, value: target.fontStyle.fontFamily }), _jsx(InspectRow, { label: messages.pickTarget.tooltipFontSize, value: target.fontStyle.fontSize }), _jsx(InspectRow, { label: messages.pickTarget.tooltipFontWeight, value: target.fontStyle.fontWeight }), _jsx(InspectRow, { label: messages.pickTarget.tooltipLineHeight, value: target.fontStyle.lineHeight })] })) : null, _jsxs("div", { className: "mt-[2px] flex flex-col gap-[6px] border-t border-[var(--adaptive-border-subtle)] pt-[6px]", children: [target.fpOpenAttribute ? (_jsx(InspectRow, { label: messages.pickTarget.tooltipFpOpen, value: target.fpOpenAttribute })) : null, _jsxs("div", { className: "flex items-start justify-between gap-[8px] text-[11px] leading-[1.45]", children: [_jsx("span", { className: "shrink-0 text-[var(--adaptive-black500)]", children: messages.pickTarget.tooltipReportId }), _jsxs("div", { className: "flex min-w-0 items-start justify-end gap-[6px]", children: [_jsx(ReportIdStatusIcon, { tagged: target.isTagged }), _jsx("span", { className: "min-w-0 break-all text-right font-[var(--coding-font)] text-[var(--adaptive-black900)]", children: reportIdValue })] })] })] })] }) }));
}
