...
const PROBE_HEADER_ACTION_CLASS = "shrink-0 rounded-[6px] border border-[var(--adaptive-border-subtle)] px-[8px] py-[3px] text-[11px] font-medium text-[var(--adaptive-black700)] hover:bg-[var(--adaptive-black100)]";
