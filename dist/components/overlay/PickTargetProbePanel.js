...
function ProbeTextField({ label, value, onChange }) {
    return (_jsxs("label", { className: "flex flex-col gap-[4px] text-[14px] leading-[1.45]", children: [_jsx("span", { className: PROBE_FIELD_LABEL_CLASS, children: label }), _jsx("input", { type: "text", "data-fivepixels-interactive": "", value: value, onChange: (event) => onChange(event.target.value), className: PROBE_INPUT_CLASS })] }));
}
