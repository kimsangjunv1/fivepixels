...
export function ReportOverlayLayer({ children }) {
    const { overlayRef, mode, hoveredTarget, selectableTargets, showTargetPreview, markerPreviewTargets, activeMarkerTarget, handleOverlayMove, handleOverlayClick, } = useReport();
