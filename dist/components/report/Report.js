...
export function Report({ project, projectId, environment, appVersion, ui, appearance, showFeedbackList, visibleShortcutKeys, shortcut, visibility, enabled, devOnly, routeKey, pathname, team, identify, authors, fields = DEFAULT_FIELDS, onList, onCreate, onUpdate, onDelete, onEvent, onReply, github, }) {
