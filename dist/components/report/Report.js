...
export function Report({ projectId, environment, appVersion, appearance = "system", storage = "local", storageAdapter, fields = DEFAULT_FIELDS, shortcut, identify, onEvent, onFeedbackCreate, onFeedbackDelete, onFeedbackReply, onFeedbackUpdate, devOnly = false, enabled = true, pathname, showFeedbackList = true, visibleShortcutKeys = false, }) {
