...
export declare function FivePixels({ project, ui, visibility, team, mode, sync, adapter, fields, onNavigate, onRevealTarget, onEvent, onReply, github, }: FivePixelsProps): import("react").JSX.Element | null;
