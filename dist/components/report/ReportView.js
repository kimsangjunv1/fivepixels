...
export function ReportView() {
    ...
    return (_jsxs(ShadowReportRoot, { panelAppearance: resolvedPanelAppearance, children: [_jsx(ThemeScope, { appearance: resolvedPanelAppearance, className: "pointer-events-none fixed inset-0 z-[999998]", children: _jsx(DotWaveOverlay, { active: mode === "report" && !isDraftCategoryStep, color: resolvedFeedbackModeDotColor, deactivateDelay: isDraftCategoryStep ? FEEDBACK_SUCCESS_HOLD_MS : 0 }) }), _jsxs(ThemeScope, { appearance: resolvedPanelAppearance, children: [_jsx(ReportControlPanel, {}), _jsx(FloatingPinRail, {})] }), showOverlay ? (_jsx(ThemeScope, { appearance: resolvedTooltipAppearance, children: _jsx(ReportOverlayLayer, { children: mode !== "idle" ? (_jsxs(_Fragment, { children: [_jsx(ReportMarkersLayer, {}), _jsx(ReportDraftMarker, {}), _jsx(ReportDraftForm, {})] })) : null }) })) : null] }));
}
