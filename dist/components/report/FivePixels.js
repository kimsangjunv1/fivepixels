...
export function FivePixels({ project, projectId, environment, appVersion, ui, appearance, showFeedbackList, visibleShortcutKeys, shortcut, visibility, enabled, devOnly, routeKey, pathname, team, identify, authors, fields = DEFAULT_FIELDS, onList, onListAll, onNavigate, onCreate, onUpdate, onDelete, onEvent, onReply, github, }) {
