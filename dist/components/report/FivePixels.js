...
export function FivePixels({ project, ui, visibility, team, mode = "default", sync = "local", requireAuth, adapter, fields = DEFAULT_FIELDS, onNavigate, onRevealTarget, onEvent, onReply, github, networkMonitor, }) {
