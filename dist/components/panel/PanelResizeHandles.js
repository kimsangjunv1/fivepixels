...
export function PanelResizeHandles({ edges, inactive = false, heightResizeEnabled = true, messages, createResizePointerDown }) {
    return (_jsx(_Fragment, { children: edges.map((edge) => (_jsx(PanelResizeHandle, { edge: edge, ariaLabel: messages.panel[EDGE_ARIA_LABEL[edge]], inactive: inactive || (!heightResizeEnabled && isVerticalResizeEdge(edge)), onPointerDown: createResizePointerDown({ kind: "edge", edge }) }, edge))) }));
}
