...
export function ReportFeedbackList() {
    const { filters, setFilters, filteredReports, reports, fields, locale, messages, isError, isFetching, isDeleting, queryErrorMessage, visibleShortcutKeys, searchInputRef, locateFeedback, refetch, handleDelete, canCreateGitHubIssue, creatingGitHubIssueId, handleCreateGitHubIssue, } = useReport();
    ...
    const githubIssueLabel = filters.githubIssue === "all"
