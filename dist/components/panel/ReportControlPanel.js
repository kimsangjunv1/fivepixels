...
export function ReportControlPanel() {
    const { appearance, resolvedAppearance, palette, isMobileViewport, mode, helperText, errorMessage, toggleReportMode, toggleViewMode, } = useReport();
    return (_jsxs("div", { style: {
            ...
            backdropFilter: "blur(14px)",
                        ...
                        }, children: mode === "report" ? "선택 중단" : "피드백 남기기" }), _jsx("button", { type: "button", onClick: toggleViewMode, style: {
