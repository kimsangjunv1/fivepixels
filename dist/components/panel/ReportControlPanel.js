...
export function ReportControlPanel() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(PanelDockGuides, { visible: isDragging, activeEdge: activeEdge }), _jsxs("div", { ref: panelRef, ...stitchablePartProps("floating-panel"), style: panelStyle, children: [_jsxs("section", { style: { display: "flex" }, children: [_jsx("div", { ...stitchablePartProps("panel-header", {
                                    ...
                                    gap: "4px",
                                    cursor: "grab",
                                }, onPointerDown: handleDragHandlePointerDown, "aria-label": "\uD328\uB110 \uC704\uCE58 \uBCC0\uACBD", title: "\uB4DC\uB798\uADF8\uD574\uC11C \uC704\uCE58 \uBCC0\uACBD", children: _jsxs("section", { children: [_jsxs("section", { style: { display: "flex" }, children: [_jsx("strong", { ...stitchablePartProps("panel-title"), children: "stitchable" }), _jsx("span", { ...stitchablePartProps("badge"), children: appearance })] }), _jsx("p", { ...stitchablePartProps("helper-text"), children: helperText })] }) }), _jsx("button", { type: "button", onClick: () => setPanelCollapsed(true), ...stitchablePartProps("secondary-button"), "aria-expanded": true, children: "\uC228\uAE30\uAE30" })] }), _jsxs("div", { ...stitchablePartProps("panel-body"), children: [_jsxs("div", { ...stitchablePartProps("button-row"), style: { display: "flex", flexDirection: "column" }, children: [_jsxs("section", { style: { display: "flex", width: "100%", gap: "4px" }, children: [_jsx("button", { type: "button", onClick: toggleReportMode, ...stitchablePartProps("primary-button", {
                                                ...
                                                }), children: _jsxs("span", { ...stitchablePartProps("button-with-hint"), children: [showListSection ? "목록 닫기" : "목록", _jsx(ShortcutHint, { binding: REPORT_SHORTCUTS.toggleViewMode, visible: visibleShortcutKeys })] }) })] }), _jsx("button", { type: "button", onClick: toggleTargetPreview, disabled: mode !== "idle", "aria-label": showTargetPreview ? "X-Ray 끄기" : "X-Ray 켜기", title: showTargetPreview ? "X-Ray 끄기" : "X-Ray 켜기", ...stitchablePartProps("secondary-button", {
