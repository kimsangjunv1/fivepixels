...
export function ReportControlPanel() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(PanelDockGuides, { visible: isDragging, activeCorner: activeCorner }), _jsxs("div", { ref: panelRef, ...stitchablePartProps("floating-panel"), style: panelStyle, children: [_jsxs("section", { style: { display: "flex", alignItems: "flex-start", gap: "8px" }, children: [_jsx("div", { ...stitchablePartProps("panel-header", {
