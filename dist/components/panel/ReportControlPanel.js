...
function PanelCollapseTab({ collapsed, anchorSide, onClick, onPointerDown, messages, }) {
    ...
    return (_jsx(HoverTooltip, { label: collapsed ? messages.panel.expand : messages.panel.collapse, className: "h-full", children: _jsx("button", { type: "button", onClick: onClick, onPointerDown: onPointerDown, "aria-expanded": !collapsed, "aria-label": collapsed ? messages.panel.expand : messages.panel.collapse, title: collapsed ? messages.panel.repositionTitle : undefined, className: collapsed
                ? anchorSide === "right"
...
export function ReportControlPanel() {
    ...
    const { panelRef, panelStyle, placementCorner, isDragging, activeEdge, handleDragHandlePointerDown, consumeClickSuppressed, } = usePanelDock({
