...
export function ReportControlPanel() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(PanelDockGuides, { visible: isDragging, activeCorner: activeCorner }), _jsxs("div", { ref: panelRef, className: "pointer-events-auto fixed z-[1000000] flex max-h-[80vh] min-h-[40px] w-[320px] flex-col", 
                ...
                // }
                style: panelStyle, children: [anchorSide === "left" ? (_jsx(PanelCollapseTab, { collapsed: panelCollapsed, anchorSide: anchorSide, onClick: () => setPanelCollapsed((current) => !current) })) : null, !panelCollapsed ? (_jsxs("section", { className: "flex flex-1 flex-col gap-[12px]", children: [_jsxs("section", { className: "flex cursor-move flex-col gap-[8px]", 
                                ...
                                onPointerDown: handleDragHandlePointerDown, "aria-label": "\uD328\uB110 \uC704\uCE58 \uBCC0\uACBD", title: "\uB4DC\uB798\uADF8\uD574\uC11C \uC704\uCE58 \uBCC0\uACBD", style: isDragging ? { opacity: 0.8 } : undefined, children: [_jsx("p", { className: "text-right text-[18px] text-[var(--adaptive-grey900)] font-bold", children: "feedback is ready." }), _jsx("p", { className: "text-right text-[14px] text-[var(--adaptive-greyOpacity600)] leading-[1.5] whitespace-break-spaces", children: helperText })] }), _jsxs("section", { className: "flex flex-1 flex-col gap-2", children: [_jsxs("div", { className: "flex items-center justify-end gap-[12px]", children: [_jsxs("section", { className: "flex items-center gap-[8px]", children: [_jsxs("button", { type: "button", onClick: toggleReportMode, className: `flex items-center gap-[4px] rounded-[12px] p-[12px] shadow-[var(--shadow-popup)] bg-[var(--adaptive-grey50)]`, children: [_jsx("p", { className: "font-bold text-[16px]", children: mode === "report" ? "Stop" : "Record" }), _jsx(ShortcutHint, { binding: REPORT_SHORTCUTS.toggleReportMode, visible: visibleShortcutKeys })] }), _jsxs("button", { type: "button", onClick: toggleViewMode, className: `flex items-center gap-[4px] rounded-[12px] p-[12px] shadow-[var(--shadow-popup)] ${showListSection
                                                            ? "border border-sky-300 bg-sky-50 text-sky-700 hover:bg-sky-100 dark:border-sky-500 dark:bg-sky-950/40 dark:text-sky-200"
                                                            : "border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-100"}`, children: [_jsx("p", { className: "font-bold text-[16px]", children: showListSection ? "off" : "list" }), _jsx(ShortcutHint, { binding: REPORT_SHORTCUTS.toggleViewMode, visible: visibleShortcutKeys })] })] }), _jsx("div", { className: "h-[24px] w-[1px] bg-[var(--adaptive-blue200)]" }), _jsxs("button", { type: "button", onClick: toggleTargetPreview, disabled: mode !== "idle", "aria-label": showTargetPreview ? "X-Ray 끄기" : "X-Ray 켜기", title: showTargetPreview ? "X-Ray 끄기" : "X-Ray 켜기", className: `${showTargetPreview
                                                    ...
                                                    : "border-slate-200 bg-white text-slate-600 shadow-sm hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-200"} flex items-center gap-[4px] rounded-[12px] p-[12px] shadow-[var(--shadow-popup)]`, children: [_jsx("p", { className: "font-bold text-[16px]", children: showTargetPreview ? _jsx(EyeOpenIcon, { className: "h-3.5 w-3.5" }) : _jsx(EyeClosedIcon, { className: "h-3.5 w-3.5" }) }), _jsx(ShortcutHint, { binding: REPORT_SHORTCUTS.toggleTargetPreview, visible: visibleShortcutKeys })] })] }), errorMessage ? (_jsx("p", { className: "mt-1 rounded-md border border-rose-200 bg-rose-50 px-2 py-1 text-[11px] text-rose-700 dark:border-rose-700 dark:bg-rose-950/40 dark:text-rose-200", children: errorMessage })) : null, showListSection ? (_jsx(ReportFeedbackList, {})) : // <div className="mt-2 flex-1">
                                        // </div>
                                        null] })] })) : null, anchorSide === "right" ? (_jsx(PanelCollapseTab, { collapsed: panelCollapsed, anchorSide: anchorSide, onClick: () => setPanelCollapsed((current) => !current) })) : null, _jsx("div", { className: "bg-[var(--adaptive-blue200)] absolute right-[-50%] bottom-[-50%] h-[150%] w-[150%] blur-[98px] z-[-1]" })] })] }));
}
