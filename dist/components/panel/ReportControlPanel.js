...
export function ReportControlPanel() {
    const { mode, targetStats, statusText, errorMessage, environment, projectId, appVersion, activeReplyReportId, showFeedbackList, showTargetPreview, isMobileViewport, panelTab, appearance, setAppearance, questionThreadDisplay, setQuestionThreadDisplay, canTransferFeedback, personalKey, publicKey, personalKeyRequired, personalKeyPendingRegistration, messages, toggleReportMode, toggleTargetPreview, toggleIssueMode, openPanelTab, setErrorMessage, refetch, } = useReport();
    ...
    return (_jsxs(_Fragment, { children: [_jsx(PanelDockGuides, { visible: isDragging, activeCorner: activeCorner }), _jsxs("div", { ref: panelRef, onDragEnter: handleDragEnter, onDragLeave: handleDragLeave, onDragOver: handleDragOver, onDrop: handleDrop, className: `pointer-events-auto z-[1000000] flex ${isRecording
