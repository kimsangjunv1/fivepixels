...
export function ReportControlPanel() {
    const { mode, roleStatItems, errorMessage, environment, projectId, appVersion, activeReplyReportId, showFeedbackList, visiblePanelTabs, isMobileViewport, panelTab, panelAppearance, setPanelAppearance, tooltipAppearance, setTooltipAppearance, questionThreadDisplay, setQuestionThreadDisplay, threadLayout, setThreadLayout, canTransferFeedback, personalKey, publicKey, panelView, messages, toggleReportMode, toggleIssueMode, openPanelTab, setErrorMessage, refetch, panelCollapsed, setPanelCollapsed, devicePreviewUiOpen, setDevicePreviewUiOpen, notificationUiOpen, toggleNotificationUiOpen, unreadNotificationCount, } = useReport();
    ...
    const { panelSize, resizeHandles, createResizePointerDown, resetPanelSize, isDefaultSize, isResizing, ghostRef } = usePanelResize({
