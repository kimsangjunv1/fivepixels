...
import { ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, EyeOpenIcon, LogoIcon, SelectIcon } from "../../components/icons/Icons.js";
...
export function ReportControlPanel() {
    const { mode, targetStats, statusText, errorMessage, environment, projectId, appVersion, activeReplyReportId, showFeedbackList, showTargetPreview, isMobileViewport, panelTab, panelAppearance, setPanelAppearance, tooltipAppearance, setTooltipAppearance, questionThreadDisplay, setQuestionThreadDisplay, canTransferFeedback, personalKey, publicKey, personalKeyRequired, personalKeyPendingRegistration, messages, toggleReportMode, toggleTargetPreview, toggleIssueMode, openPanelTab, setErrorMessage, refetch, } = useReport();
    ...
    const panelSideControls = panelExpanded ? (_jsxs("div", { className: "flex shrink-0 flex-col items-center", children: [_jsx(PanelCollapseTab, { collapsed: panelCollapsed, anchorSide: anchorSide, onClick: handleTogglePanelCollapsed, messages: messages }), _jsx(PanelSizeResetButton, { collapsed: panelCollapsed, disabled: isDefaultSize, label: messages.panel.resetSizeTitle, onClick: resetPanelSize })] })) : null;
    return (_jsxs(_Fragment, { children: [_jsx(PanelDockGuides, { visible: isDragging, activeCorner: activeCorner }), isResizing ? (_jsx(CornerResizeGhost, { ghostRef: ghostRef, zIndexClassName: "z-[1000001]" })) : null, _jsxs("div", { ref: panelRef, onDragEnter: handleDragEnter, onDragLeave: handleDragLeave, onDragOver: handleDragOver, onDrop: handleDrop, className: `pointer-events-auto z-[1000000] flex ${isRecording
                    ...
                    : panelCollapsed
                        ? ""
                        : "relative bg-[var(--adaptive-blackOpacity700)] backdrop-blur-[10px] rounded-[12px] border-0 shadow-[0_0_120px_0_var(--adaptive-blackOpacity500)]"}`, style: { ...resolvedPanelStyle, ...resolvedSizeStyle, fontSize: "14px" }, children: [panelExpanded ? (_jsx(CornerResizeHandle, { corner: resizeCorner, ariaLabel: messages.panel.resizeAriaLabel, inactive: isDragging, onPointerDown: handleResizePointerDown })) : null, _jsxs("div", { className: panelCollapsed && !isRecording ? "flex shrink-0" : `flex w-full min-w-0 flex-col ${applyFixedHeight ? "h-full min-h-0" : ""}`, children: [panelCollapsed && !isRecording ? null : _jsx(ProbeEditModeBanner, {}), isRecording ? (_jsxs("section", { className: "flex items-center justify-between gap-[16px] px-[12px] py-[8px]", children: [_jsx("section", { className: "flex items-center gap-[4px] justify-start shrink-0", children: _jsx(LogoIcon, { className: "w-[94px]" }) }), _jsx("button", { type: "button", onClick: toggleReportMode, className: "flex items-center shrink-0", children: _jsx("p", { className: "text-[14px] font-bold text-[var(--adaptive-blue500)]", children: messages.panel.stopFeedback }) })] })) : panelCollapsed ? (_jsx(PanelCollapseTab, { collapsed: panelCollapsed, anchorSide: anchorSide, onClick: handleTogglePanelCollapsed, messages: messages })) : (_jsx(_Fragment, { children: _jsxs("section", { className: `relative flex min-w-0 flex-col ${applyFixedHeight ? "h-full min-h-0 flex-1" : "shrink-0"}`, children: [isDragOver ? (_jsx("div", { className: "pointer-events-none absolute inset-0 z-[30] flex items-center justify-center rounded-[12px] bg-[#dbeafe]/90 px-[16px] text-center backdrop-blur-[2px]", children: _jsx("p", { className: "text-[14px] font-bold text-[var(--adaptive-blue500)]", children: messages.panel.importDragOverlay }) })) : null, _jsxs("section", { className: "flex shrink-0", children: [anchorSide === "left" ? panelSideControls : null, _jsxs("div", { className: "flex flex-1 flex-col gap-[8px] p-[8px_8px_8px_12px]", children: [_jsxs("section", { className: "flex items-center justify-between gap-[8px]", children: [_jsx("section", { className: "flex min-w-0 items-center gap-[4px]", children: _jsx(LogoIcon, { className: "w-[94px] shrink-0" }) }), _jsxs("section", { className: "flex shrink-0 items-center gap-[4px]", children: [_jsxs("button", { type: "button", onClick: toggleReportMode, className: "flex items-center gap-[4px] rounded-[8px] bg-[var(--adaptive-black100)] p-[0_8px] h-[24px]", children: [_jsx(SelectIcon, { className: "w-[16px]" }), _jsx("p", { className: "text-[12px] text-[var(--adaptive-black900)]", children: messages.panel.addFeedback })] }), _jsx(IconTooltipButton, { label: messages.panel.viewFeedbacks, active: isIssueMode, onClick: toggleIssueMode, children: _jsx(EyeOpenIcon, { className: "h-[16px] w-[16px]" }) })] })] }), _jsx("section", { className: "flex gap-[12px]", children: _jsxs("section", { className: "flex flex-1 cursor-move touch-none select-none", onPointerDown: handleDragHandlePointerDown, "aria-label": messages.panel.repositionAriaLabel, title: messages.panel.repositionTitle, style: isDragging ? { opacity: 0.8 } : undefined, children: [_jsxs("section", { className: "flex flex-col items-start gap-[4px] flex-1", children: [_jsx("p", { className: "text-[12px] text-[var(--adaptive-black500)]", children: messages.panel.statsFound }), _jsx("p", { className: `text-[14px] font-semibold text-[var(--adaptive-black900)] ${panelNumericClassName}`, children: formatStatCount(targetStats.found) })] }), _jsxs("section", { className: "flex flex-col items-start gap-[4px] flex-1", children: [_jsx("p", { className: "text-[12px] text-[var(--adaptive-black500)]", children: messages.panel.statsResolved }), _jsx("p", { className: `text-[14px] font-semibold text-[var(--adaptive-black900)] ${panelNumericClassName}`, children: formatStatCount(targetStats.resolved) })] }), _jsxs("section", { className: "flex flex-col items-start gap-[4px] flex-1", children: [_jsx("p", { className: "text-[12px] text-[var(--adaptive-black500)]", children: messages.panel.statsInProgress }), _jsx("p", { className: `text-[14px] font-semibold text-[var(--adaptive-black900)] ${panelNumericClassName}`, children: formatStatCount(targetStats.inProgress) })] })] }) })] }), anchorSide === "right" ? panelSideControls : null] }), _jsx("section", { className: "flex shrink-0 items-stretch border-t border-[var(--adaptive-border-subtle)]", children: _jsxs("div", { className: "flex min-w-0 flex-1 overflow-hidden", children: [_jsx(PanelTabButton, { label: messages.panel.tabPageDetails, active: panelTab === "route-details", onClick: () => handlePanelTabClick("route-details") }), _jsx("div", { className: "h-full w-[1px] bg-[var(--adaptive-border-subtle)]" }), showFeedbackList ? (_jsxs(_Fragment, { children: [_jsx(PanelTabButton, { label: messages.panel.tabFeedbackList, active: panelTab === "feedback-list", onClick: () => handlePanelTabClick("feedback-list") }), _jsx("div", { className: "h-full w-[1px] bg-[var(--adaptive-border-subtle)]" })] })) : null, _jsx(PanelTabButton, { label: messages.panel.tabSettings, active: panelTab === "settings" || panelTab === "command", onClick: () => handlePanelTabClick("settings") })] }) }), errorMessage && importStep === "none" && commandStep === "none" && !activeReplyReportId ? _jsx("p", { className: "px-[8px] text-[12px] text-rose-700", children: errorMessage }) : null, personalKeyNotice ? _jsx("p", { className: "px-[8px] py-[4px] text-[12px] text-[var(--adaptive-green500)]", children: personalKeyNotice }) : null, personalKeyPendingRegistration ? _jsx("p", { className: "px-[8px] py-[4px] text-[12px] text-amber-700", children: messages.personalKey.registrationPending }) : null, personalKeyStep !== "none" ? (_jsx(ReportPersonalKeyDialog, { mode: personalKeyStep, onCancel: () => setPersonalKeyStep("none"), onComplete: (message) => {
                                                setPersonalKeyNotice(message);
                                                setPersonalKeyStep("none");
                                            } })) : null, personalKeyStep === "none" && importStep === "project-mismatch" && pendingImport ? (_jsx(ReportImportProjectMismatchDialog, { currentProject: transferScope, importedProject: pendingImport.project, exportedAt: pendingImport.exportedAt, onProceed: handleProceedImportAfterMismatch, onCancel: handleCancelImport })) : null, personalKeyStep === "none" && importStep === "confirm" && pendingImport ? (_jsx(ReportImportConfirmDialog, { onApply: handleApplyImport, onCancel: handleCancelImport, onBackupAndApply: handleBackupAndApplyImport })) : null, contentSectionOpen ? (_jsxs("div", { className: applyFixedHeight ? "flex min-h-0 flex-1 flex-col overflow-hidden" : "flex flex-col", children: [panelTab === "route-details" && commandStep === "none" ? _jsx(ReportRouteDetails, {}) : null, panelTab === "feedback-list" && showFeedbackList && commandStep === "none" ? _jsx(ReportFeedbackList, {}) : null, panelTab === "settings" && commandStep === "none" ? (_jsx(PanelSettings, { transferDisabled: !canTransferFeedback, panelAppearance: panelAppearance, onPanelAppearanceChange: setPanelAppearance, tooltipAppearance: tooltipAppearance, onTooltipAppearanceChange: setTooltipAppearance, questionThreadDisplay: questionThreadDisplay, onQuestionThreadDisplayChange: setQuestionThreadDisplay, onExport: handleExport, onImport: handleImportFromMenu, onCommand: handleOpenCommand, hasPersonalKey: Boolean(personalKey), onKeyCopy: () => void handleKeyCopy(), onPublicKeyCopy: () => void handlePublicKeyCopy(), onKeyInsert: () => {
