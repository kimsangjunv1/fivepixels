...
export function ReportControlPanel() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(PanelDockGuides, { visible: isDragging, activeCorner: activeCorner }), _jsx(motion.div, { ref: panelRef, transition: { duration: 0.25, ease: "cubic-bezier(0.22, 1, 0.36, 1)" }, onDragEnter: handleDragEnter, onDragLeave: handleDragLeave, onDragOver: handleDragOver, onDrop: handleDrop, className: `pointer-events-auto fixed z-[1000000] bg-[var(--adaptive-surface-overlay)] overflow-hidden backdrop-blur-[50px] rounded-[24px] shadow-[0_0_120px_0_var(--adaptive-blackOpacity500)] flex ${isRecording ? "min-h-[40px] p-[4px]" : "max-h-[calc(100svh-(16px*2))] max-w-[calc(100svw-(16px*2))]"}`, style: { ...panelStyle, fontSize: "14px" }, children: _jsx(motion.div, { className: "flex min-w-0 flex-1 flex-col w-full", children: isRecording ? (_jsxs("section", { className: "flex items-center justify-between gap-[16px] px-[12px] py-[8px]", children: [_jsxs("section", { className: "flex items-center gap-[4px] justify-start shrink-0", children: [_jsx(LogoIcon, { className: "w-[16px]" }), _jsx("p", { className: "text-[var(--adaptive-black900)] text-[14px]", children: "Stitchable\u00B0" })] }), _jsx("button", { type: "button", onClick: toggleReportMode, className: "flex items-center shrink-0", children: _jsx("p", { className: "text-[14px] font-bold text-[var(--adaptive-blue500)]", children: messages.panel.stopFeedback }) })] })) : (_jsx(_Fragment, { children: !panelCollapsed ? (_jsxs("section", { className: "relative flex min-w-0 flex-1 flex-col h-full", children: [isDragOver ? (_jsx("div", { className: "pointer-events-none absolute inset-0 z-[30] flex items-center justify-center rounded-[12px] bg-[#dbeafe]/90 px-[16px] text-center backdrop-blur-[2px]", children: _jsx("p", { className: "text-[14px] font-bold text-[var(--adaptive-blue500)]", children: messages.panel.importDragOverlay }) })) : null, _jsxs("section", { className: "flex", children: [anchorSide === "left" ? (_jsx(PanelCollapseTab, { collapsed: panelCollapsed, anchorSide: anchorSide, onClick: () => setPanelCollapsed((current) => !current), messages: messages })) : null, _jsxs("div", { className: "flex flex-col gap-[8px] p-[8px_8px_8px_12px] flex-1", children: [_jsxs("section", { className: "flex items-center justify-between gap-[8px]", children: [_jsxs("section", { className: "flex min-w-0 items-center gap-[4px]", children: [_jsx(LogoIcon, { className: "w-[16px] shrink-0" }), _jsx("p", { className: "shrink-0 text-[var(--adaptive-black900)] font-[700] text-[14px] select-none", children: "Stitchable\u00B0" }), _jsx(EnvironmentBadge, { environment: environment })] }), _jsxs("section", { className: "flex shrink-0 items-center", children: [_jsxs("button", { type: "button", onClick: toggleReportMode, className: "flex items-center gap-[4px] rounded-l-[8px] bg-[var(--adaptive-surface-inverse)] p-[0_8px]", children: [_jsx(SelectIcon, { className: "w-[16px]" }), _jsx("p", { className: "text-[12px] text-[var(--adaptive-text-inverse)]", children: messages.panel.addFeedback })] }), _jsxs(PanelDropdownMenu, { open: viewMenuOpen, onClose: () => setViewMenuOpen(false), menuClassName: "min-w-[200px]", trigger: _jsx("button", { type: "button", onClick: () => setViewMenuOpen((current) => !current), "aria-expanded": viewMenuOpen, "aria-haspopup": "menu", "aria-label": messages.panel.viewOptionsAriaLabel, className: "flex items-center rounded-r-[8px] border-l border-[var(--adaptive-border-subtle)] bg-[var(--adaptive-surface-inverse)] p-[2px_8px] h-[24px]", children: _jsx(ChevronDownIcon, { className: `h-4 w-4 text-[var(--adaptive-text-inverse)] transition-transform ${viewMenuOpen ? "rotate-180" : ""}` }) }), children: [_jsx(PanelDropdownMenuItem, { active: showTargetPreview, disabled: mode !== "idle", onClick: () => {
                                            ...
                                            } })] }), errorMessage && importStep === "none" && commandStep === "none" ? _jsx("p", { className: "px-[8px] text-[12px] text-rose-700", children: errorMessage }) : null, personalKeyNotice ? _jsx("p", { className: "px-[8px] py-[4px] text-[12px] text-[var(--adaptive-green500)]", children: personalKeyNotice }) : null, personalKeyStep !== "none" ? (_jsx(ReportPersonalKeyDialog, { mode: personalKeyStep, onCancel: () => setPersonalKeyStep("none"), onComplete: (message) => {
