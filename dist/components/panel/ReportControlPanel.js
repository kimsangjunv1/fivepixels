...
export function ReportControlPanel() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(PanelDockGuides, { visible: isDragging, activeCorner: activeCorner }), _jsxs("div", { ref: panelRef, ...stitchablePartProps("floating-panel", { className: floatingPanelClassName }), style: panelStyle, children: [_jsx(PanelProgressiveBlur, { hidden: panelCollapsed }), anchorSide === "left" ? (_jsx(PanelCollapseTab, { collapsed: panelCollapsed, anchorSide: anchorSide, onClick: () => setPanelCollapsed((current) => !current) })) : null, _jsxs("section", { ...stitchablePartProps("panel-content"), children: [_jsx("section", { ...stitchablePartProps("panel-header", {
                                    ...
                                    className: stitchableClass("panel-header", panelHeaderAlignModifier(placementCorner)),
                                                            ...
                                                            }), children: _jsxs("span", { ...stitchablePartProps("button-with-hint"), children: [showListSection ? "목록 닫기" : "목록", _jsx(ShortcutHint, { binding: REPORT_SHORTCUTS.toggleViewMode, visible: visibleShortcutKeys })] }) })] }), _jsx("div", { ...stitchablePartProps("button-divider") }), _jsx("button", { type: "button", onClick: toggleTargetPreview, disabled: mode !== "idle", "aria-label": showTargetPreview ? "X-Ray 끄기" : "X-Ray 켜기", title: showTargetPreview ? "X-Ray 끄기" : "X-Ray 켜기", ...stitchablePartProps("secondary-button", {
