...
export function ReportControlPanel() {
    ...
    return (_jsxs("div", { ref: panelRef, className: "pointer-events-auto fixed z-30 flex max-h-[80vh] min-h-[40px] w-[320px] flex-col overflow-hidden rounded-lg border border-slate-300 bg-[var(--adaptive-grey50)] shadow-lg", 
        // className={
        //     panelCollapsed
