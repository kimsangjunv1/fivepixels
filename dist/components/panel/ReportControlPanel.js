...
function PanelTabButton({ label, active, onClick }) {
    return (_jsxs("button", { type: "button", onClick: onClick, className: `flex flex-1 items-center justify-center gap-[6px] px-[10px] py-[4px] ${active ? "bg-[var(--adaptive-black50)] text-[var(--adaptive-black900)]" : "text-[var(--adaptive-black600)]"}`, children: [_jsx("span", { children: label }), _jsx(ChevronDownIcon, { className: `h-4 w-4 transition-transform ${active ? "rotate-180" : ""}` })] }));
}
...
export function ReportControlPanel() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(PanelDockGuides, { visible: isDragging, activeCorner: activeCorner }), isRecording && statusText ? (_jsx("div", { className: "pointer-events-none fixed bottom-[52px] left-0 right-0 z-[1000000] flex flex-col items-center gap-[4px] px-4 text-center text-white", style: { filter: RECORDING_STATUS_SHADOW }, children: statusText.split("\n").map((line, index) => (_jsx("p", { className: index === 0 ? "text-[12px] font-medium" : "text-[18px] font-bold", children: line }, `${index}-${line}`))) })) : null, _jsx(motion.div, { ref: panelRef, layout: true, layoutId: "asdwsww", onDragEnter: handleDragEnter, onDragLeave: handleDragLeave, onDragOver: handleDragOver, onDrop: handleDrop, className: `pointer-events-auto fixed z-[1000000] overflow-hidden rounded-[24px] shadow-[0_0_120px_0_var(--adaptive-blackOpacity500)] flex ${isRecording ? "min-h-[40px] p-[4px]" : "max-h-[80vh] min-h-[40px] max-w-[375px]"}`, style: { ...panelStyle, fontSize: "14px" }, children: isRecording ? (_jsxs("section", { className: "flex items-center justify-between gap-[16px] px-[12px] py-[8px]", children: [_jsxs("section", { className: "flex items-center gap-[4px] justify-start shrink-0", children: [_jsx(LogoIcon, { className: "w-[18px]" }), _jsx("p", { className: "text-[var(--adaptive-black900)] font-[900] text-[18px]", children: "Radar\u00B0" })] }), _jsx("button", { type: "button", onClick: toggleReportMode, className: "flex items-center shrink-0", children: _jsx("p", { className: "text-[14px] font-bold text-[var(--adaptive-blue500)]", children: "Stop Recording..." }) })] })) : (_jsx(_Fragment, { children: !panelCollapsed ? (_jsxs("section", { className: "relative flex min-w-0 flex-1 flex-col", children: [isDragOver ? (_jsx("div", { className: "pointer-events-none absolute inset-0 z-[30] flex items-center justify-center rounded-[12px] bg-[#dbeafe]/90 px-[16px] text-center backdrop-blur-[2px]", children: _jsx("p", { className: "text-[14px] font-bold text-[var(--adaptive-blue500)]", children: "\uC120\uD0DD\uD558\uC2E0 JSON\uC744 import \uD569\uB2C8\uB2E4" }) })) : null, _jsxs("section", { className: "flex bg-[var(--adaptive-whiteOpacity700)] backdrop-blur-[50px]", children: [anchorSide === "left" ? (_jsx(PanelCollapseTab, { collapsed: panelCollapsed, anchorSide: anchorSide, onClick: () => setPanelCollapsed((current) => !current) })) : null, _jsxs("div", { className: "flex flex-col gap-[8px] p-[16px]", children: [_jsxs("section", { className: "flex items-center justify-between gap-[8px]", children: [_jsxs("section", { className: "flex min-w-0 items-center gap-[6px]", children: [_jsx(LogoIcon, { className: "w-[18px] shrink-0" }), _jsx("p", { className: "shrink-0 text-[var(--adaptive-black900)] font-[700] text-[16px]", children: "Radar\u00B0" }), _jsx(EnvironmentBadge, { environment: environment })] }), _jsxs("section", { className: "flex shrink-0 items-center gap-[4px]", children: [_jsx("button", { type: "button", onClick: toggleReportMode, className: "p-[4px_8px] rounded-[8px] bg-[var(--adaptive-black200)]", children: _jsx("p", { className: "text-[12px] font-bold tracking-wide text-[var(--adaptive-black500)]", children: "RECORD" }) }), _jsx("button", { type: "button", onClick: toggleIssueMode, className: isIssueMode ? "rounded-full bg-[var(--adaptive-black300)] px-[10px] py-[4px]" : "p-[4px_8px] rounded-[8px] bg-[var(--adaptive-black200)]", "aria-pressed": isIssueMode, children: _jsx("p", { className: "text-[12px] font-bold tracking-wide text-[var(--adaptive-black500)]", children: "ISSUE" }) }), _jsx("button", { type: "button", onClick: toggleTargetPreview, disabled: mode !== "idle", "aria-label": showTargetPreview ? "X-Ray 끄기" : "X-Ray 켜기", title: showTargetPreview ? "X-Ray 끄기" : "X-Ray 켜기", className: showTargetPreview ? "rounded-full bg-[var(--adaptive-black300)] px-[10px] py-[4px]" : "p-[4px_8px] rounded-[8px] bg-[var(--adaptive-black200)]", "aria-pressed": showTargetPreview, children: _jsx("p", { className: "text-[12px] font-bold tracking-wide text-[var(--adaptive-black500)]", children: "X-RAY" }) })] })] }), _jsxs("section", { className: "flex cursor-move", onPointerDown: handleDragHandlePointerDown, "aria-label": "\uD328\uB110 \uC704\uCE58 \uBCC0\uACBD", title: "\uB4DC\uB798\uADF8\uD574\uC11C \uC704\uCE58 \uBCC0\uACBD", style: isDragging ? { opacity: 0.8 } : undefined, children: [_jsxs("section", { className: "flex flex-col items-start gap-[4px] flex-1", children: [_jsx("p", { className: "text-[12px] text-[var(--adaptive-black500)]", children: "Found" }), _jsx("p", { className: `text-[18px] font-semibold text-[var(--adaptive-black900)] ${panelNumericClassName}`, children: formatStatCount(targetStats.found) })] }), _jsxs("section", { className: "flex flex-col items-start gap-[4px] flex-1", children: [_jsx("p", { className: "text-[12px] text-[var(--adaptive-black500)]", children: "Group" }), _jsx("p", { className: `text-[18px] font-semibold text-[var(--adaptive-black900)] ${panelNumericClassName}`, children: formatStatCount(targetStats.group) })] }), _jsxs("section", { className: "flex flex-col items-start gap-[4px] flex-1", children: [_jsx("p", { className: "text-[12px] text-[var(--adaptive-black500)]", children: "Item" }), _jsx("p", { className: `text-[18px] font-semibold text-[var(--adaptive-black900)] ${panelNumericClassName}`, children: formatStatCount(targetStats.item) })] })] })] }), anchorSide === "right" ? (_jsx(PanelCollapseTab, { collapsed: panelCollapsed, anchorSide: anchorSide, onClick: () => setPanelCollapsed((current) => !current) })) : null] }), _jsxs("section", { className: "flex items-stretch border-t border-[var(--adaptive-black200)] bg-[var(--adaptive-black200)]", children: [_jsxs("div", { className: "flex min-w-0 flex-1 overflow-hidden", children: [_jsx(PanelTabButton, { label: "Page Details", active: panelTab === "route-details", onClick: () => handlePanelTabClick("route-details") }), _jsx("div", { className: "h-full w-[1px] bg-[var(--adaptive-black200)]" }), showFeedbackList ? (_jsx(PanelTabButton, { label: "Feedback List", active: panelTab === "feedback-list", onClick: () => handlePanelTabClick("feedback-list") })) : null] }), _jsx("div", { className: "h-full w-[1px] bg-[var(--adaptive-black200)]" }), _jsx(PanelMoreMenu, { open: moreMenuOpen, disabled: !canTransferFeedback, onToggle: () => setMoreMenuOpen((current) => !current), onClose: () => setMoreMenuOpen(false), onExport: handleExport, onImport: handleImportFromMenu })] }), errorMessage && !pendingImport ? _jsx("p", { className: "px-[8px] text-[12px] text-rose-700", children: errorMessage }) : null, pendingImport ? (_jsx(ReportImportConfirmDialog, { onApply: handleApplyImport, onCancel: handleCancelImport, onBackupAndApply: handleBackupAndApplyImport })) : null, panelTab === "route-details" && !pendingImport ? _jsx(ReportRouteDetails, {}) : null, panelTab === "feedback-list" && showFeedbackList && !pendingImport ? _jsx(ReportFeedbackList, {}) : null] })) : null })) })] }));
}
