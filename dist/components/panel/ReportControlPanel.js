...
export function ReportControlPanel() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(PanelDockGuides, { visible: isDragging, activeCorner: activeCorner }), _jsxs("div", { ref: panelRef, className: "pointer-events-auto fixed z-[1000000] flex max-h-[80vh] min-h-[40px] w-[320px] flex-col", 
                ...
                style: panelStyle, children: [anchorSide === "left" ? (_jsx(PanelCollapseTab, { collapsed: panelCollapsed, anchorSide: anchorSide, onClick: () => setPanelCollapsed((current) => !current) })) : null, !panelCollapsed ? (_jsxs("section", { className: "flex flex-1 flex-col gap-[12px]", children: [_jsxs("section", { className: "flex cursor-move flex-col gap-[8px]", 
                                ...
                                onPointerDown: handleDragHandlePointerDown, "aria-label": "\uD328\uB110 \uC704\uCE58 \uBCC0\uACBD", title: "\uB4DC\uB798\uADF8\uD574\uC11C \uC704\uCE58 \uBCC0\uACBD", style: isDragging ? { opacity: 0.8 } : undefined, children: [_jsx("p", { className: "text-right text-[18px] text-[var(--adaptive-grey900)] font-bold", children: "\uD53C\uB4DC\uBC31\uC744 \uC218\uC9D1 \uC911..." }), _jsx("p", { className: "text-right text-[14px] text-[var(--adaptive-greyOpacity600)] leading-[1.5]", children: helperText })] }), _jsxs("section", { className: "flex flex-1 flex-col gap-2", children: [_jsxs("div", { className: "flex items-center justify-end gap-2", children: [_jsxs("button", { type: "button", onClick: toggleReportMode, className: `flex items-center gap-[4px] rounded-[12px] p-[12px] shadow-[var(--shadow-popup)] bg-[var(--adaptive-grey50)]`, children: [_jsx("p", { className: "font-bold text-[16px]", children: mode === "report" ? "중단" : "기록" }), _jsx(ShortcutHint, { binding: REPORT_SHORTCUTS.toggleReportMode, visible: visibleShortcutKeys })] }), _jsx("button", { type: "button", onClick: toggleViewMode, className: `flex items-center gap-[4px] rounded-[12px] p-[12px] ${showListSection
