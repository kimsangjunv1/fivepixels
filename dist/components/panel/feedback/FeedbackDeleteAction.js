...
export function FeedbackDeleteAction({ reportId, onDelete, disabled = false, messages, className = "flex h-[20px] w-[20px] items-center justify-center disabled:opacity-50", iconClassName = "h-[12px] w-[12px]", }) {
