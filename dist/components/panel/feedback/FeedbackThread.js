...
const SCROLL_HINT_CLASS = "pointer-events-none absolute left-0 right-0 z-10 px-[16px] py-[6px] text-center text-[12px] text-[var(--adaptive-black500)]";
