...
function ThreadEntryActions({ reply, report, authors, pendingComposer, confirmAuthorName, showConfirmAuthorSelect, onConfirmAuthorNameChange, onToggleConfirmAuthorSelect, onStartDeny, onStartCheckout, onConfirm, isUpdating, }) {
    ...
    return (_jsxs("div", { className: "mt-[10px] flex flex-col gap-[8px]", children: [_jsxs("div", { className: "flex gap-[8px]", children: [showReview ? (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", "data-stitchable-interactive": "", disabled: isUpdating, onClick: onStartDeny, className: denyActive
                                    ...
                                    : "flex-1 rounded-full border border-[var(--adaptive-black400)] px-[12px] py-[8px] text-[12px] font-semibold text-[var(--adaptive-black700)]", children: "denied" }), _jsx("button", { type: "button", "data-stitchable-interactive": "", disabled: isUpdating, onClick: onConfirm, className: "flex-1 rounded-full border border-[var(--adaptive-black400)] px-[12px] py-[8px] text-[12px] font-semibold text-[var(--adaptive-black700)]", children: "confirm" }), _jsx("button", { type: "button", "data-stitchable-interactive": "", disabled: isUpdating, onClick: onToggleConfirmAuthorSelect, className: showConfirmAuthorSelect
                                    ? "shrink-0 rounded-full bg-[var(--adaptive-black900)] px-[12px] py-[8px] text-[12px] font-semibold text-[var(--adaptive-black50)]"
                                    : "shrink-0 rounded-full border border-[var(--adaptive-black400)] px-[12px] py-[8px] text-[12px] font-semibold text-[var(--adaptive-black700)]", children: "select" })] })) : null, showCheckout ? (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", "data-stitchable-interactive": "", disabled: true, className: "flex-1 rounded-full border border-[var(--adaptive-black400)] px-[12px] py-[8px] text-[12px] font-semibold text-[var(--adaptive-black500)] opacity-60", children: "denied" }), _jsx("button", { type: "button", "data-stitchable-interactive": "", disabled: isUpdating, onClick: () => onStartCheckout(reply.id), className: checkoutActive
                                    ? "flex-1 rounded-full bg-[var(--adaptive-black900)] px-[12px] py-[8px] text-[12px] font-semibold text-[var(--adaptive-black50)]"
                                    : "flex-1 rounded-full border border-[var(--adaptive-black400)] px-[12px] py-[8px] text-[12px] font-semibold text-[var(--adaptive-black700)]", children: "checkout" })] })) : null] }), showReview && showConfirmAuthorSelect ? (_jsx(AuthorSelector, { authors: confirmAuthorOptions, value: confirmAuthorName, onChange: onConfirmAuthorNameChange })) : null] }));
}
export function FeedbackThread({ report, authors, pendingComposer, confirmAuthorName, showConfirmAuthorSelect, onConfirmAuthorNameChange, onToggleConfirmAuthorSelect, onStartDeny, onStartCheckout, onConfirm, isUpdating, }) {
    ...
    return (_jsx("section", { className: "flex flex-col bg-[var(--adaptive-black50)] max-h-[512px] overflow-auto", children: chronological.map((reply) => (_jsxs("article", { className: "flex flex-col gap-[8px] border-t border-[var(--adaptive-blackOpacity200)] p-[16px]", children: [_jsxs("div", { className: "flex items-start justify-between gap-[8px]", children: [_jsx(FeedbackStatusBadge, { status: reply.status }), _jsx("span", { className: "text-[12px] text-[var(--adaptive-black500)]", children: formatDate(reply.created_at) })] }), _jsx("p", { className: "leading-[1.45] text-[var(--adaptive-black900)]", children: reply.message }), reply.author_name ? _jsx("p", { className: "text-[12px] text-[var(--adaptive-black500)]", children: reply.author_name }) : null, _jsx(ThreadEntryActions, { reply: reply, report: report, authors: authors, pendingComposer: pendingComposer, confirmAuthorName: confirmAuthorName, showConfirmAuthorSelect: showConfirmAuthorSelect, onConfirmAuthorNameChange: onConfirmAuthorNameChange, onToggleConfirmAuthorSelect: onToggleConfirmAuthorSelect, onStartDeny: onStartDeny, onStartCheckout: onStartCheckout, onConfirm: onConfirm, isUpdating: isUpdating })] }, reply.id))) }));
}
