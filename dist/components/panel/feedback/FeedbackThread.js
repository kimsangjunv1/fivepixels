...
function ThreadIssueEntry({ report, children, locale, originalAuthorName, threadReplyPrefix, pendingComposer, onStartAskQuestion, onStartCheckout, isUpdating, }) {
    const { caseEditReportId, caseEditCases, beginCaseEdit, cancelCaseEdit, handleCaseEditSave, updateCaseEditDraftCase, addCaseEditDraftCase, removeCaseEditDraftCase, errorMessage, } = useReport();
