...
export function FeedbackHoverCard({ report, detached = false, detachedKind = null, detachedHint, detachedModalHint }) {
    ...
    return (_jsxs("div", { className: "flex w-[260px] flex-col bg-transparent", children: [_jsx("div", { className: "shrink-0 border-b border-[var(--adaptive-border-subtle)] bg-[var(--adaptive-tintOpacity500)] px-[8px] py-[6px]", children: _jsx("p", { className: "text-[12px] font-semibold leading-none text-[var(--adaptive-black50)]", children: messages.marker.hoverTooltipHeader }) }), _jsxs("div", { className: "flex flex-col gap-[6px] p-[8px]", children: [resolvedDetachedHint ? _jsx("p", { className: "text-[12px] leading-[1.4] text-[var(--adaptive-black500)]", children: resolvedDetachedHint }) : null, _jsx("ul", { className: "flex flex-col gap-[4px]", children: visibleCases.map((item) => {
