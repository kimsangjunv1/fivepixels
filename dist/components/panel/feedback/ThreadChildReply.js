...
export function ThreadChildReply({ reply, authors, originalAuthorName, actorName }) {
    ...
    return (_jsxs(ThreadTimelineRow, { children: [_jsx("p", { className: "leading-[1.5] text-[13px] text-[var(--adaptive-text-primary)]", children: _jsx(MentionMessage, { message: reply.message, mentions: reply.mentions }) }), authorName ? (_jsx(ThreadAuthorMeta, { authorName: authorName, authors: authors, createdAt: reply.created_at, showMine: authorName === actorName, showCreator: authorName === originalAuthorName })) : null] }));
}
