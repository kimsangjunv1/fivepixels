...
export function CaseThreadEntryActions({ report, caseId, actorName, onStartAskQuestion, onClaimAssignee, isUpdating, isClaimingAssignee, }) {
    const { messages } = useReportPreferences();
