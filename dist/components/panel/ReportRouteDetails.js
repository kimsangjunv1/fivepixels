...
export function ReportRouteDetails() {
    ...
    return (_jsxs("section", { className: "flex flex-col bg-[var(--adaptive-black50)] border-t border-t-[var(--adaptive-black200)] rounded-[0_0_24px_24px] overflow-hidden", children: [_jsxs("article", { className: "flex flex-col px-[16px]", children: [_jsxs("section", { className: "flex items-center text-[12px] py-[8px]", children: [_jsx("div", { className: "flex-1", children: _jsx("p", { className: "text-[var(--adaptive-black500)] font-[500]", children: pathname }) }), _jsxs("div", { className: "flex-1 flex", children: [_jsx("p", { className: "flex-1 text-[var(--adaptive-black500)] font-[500]", children: "All" }), _jsx("p", { className: "flex-1 text-[var(--adaptive-black500)] font-[500]", children: "Today" })] })] }), _jsx("div", { className: "w-full h-[1px] bg-[var(--adaptive-black200)]" }), statusRows.map((row, mappedIdx) => {
            ...
            _jsx("article", { className: "flex border-t border-[var(--adaptive-black200)]", children: fieldCounts.map((field, mappedIdx) => {
                    ...
                    return (_jsxs(Fragment, { children: [_jsxs("section", { className: "flex-1 flex flex-col items-center gap-[4px] text-center py-[0.4rem]", children: [_jsx(ChevronDownIcon, { className: `h-4 w-4 transition-transform` }), _jsx("span", { className: "text-[var(--adaptive-black500)]", children: field.label }), _jsx("p", { className: `font-normal text-[var(--adaptive-black900)] ${panelNumericClassName}`, children: formatStatCount(field.count) })] }), IS_NOT_LAST ? _jsx("div", { className: "w-[1px] h-full bg-[var(--adaptive-black200)]" }) : null] }, field.key));
