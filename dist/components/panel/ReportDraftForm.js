...
export function ReportDraftForm() {
    ...
    return (_jsxs("div", { onClick: (event) => event.stopPropagation(), className: cardSurface, style: {
        ...
        }, children: [_jsxs("p", { className: textTitle, children: [draft.reportType, " \u00B7 ", draft.reportId] }), _jsx("div", { className: stack, children: _jsx(FieldEditor, { fields: fields, message: draft.message, fieldValues: draft.fieldValues, onMessageChange: updateDraftMessage, onFieldChange: updateDraftField }) }), _jsxs("div", { className: btnRow, children: [_jsx("button", { type: "button", onClick: cancelDraft, className: btnSecondary, children: _jsxs("span", { className: btnHint, children: ["\uCDE8\uC18C", _jsx(ShortcutHint, { binding: REPORT_SHORTCUTS.cancel, visible: visibleShortcutKeys })] }) }), _jsx("button", { type: "button", onClick: () => void handleCreateSubmit(), disabled: isCreating, className: btnPrimary, children: _jsxs("span", { className: btnHint, children: [isCreating ? "저장 중..." : "저장", _jsx(ShortcutHint, { binding: REPORT_SHORTCUTS.submit, visible: visibleShortcutKeys })] }) })] })] }));
}
