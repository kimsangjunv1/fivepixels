...
export function DraftNetworkErrorBanner() {
    ...
    return (_jsx(ReportPanelNoticeDialog, { role: "alert", title: messages.apiFlow.draftBannerTitle, description: formatApiFlowSummaryLine(activeApiFailureAlert, messages), actions: [
            {
                id: "attach",
