...
export function PanelSettings({ transferDisabled = false, appearance, onAppearanceChange, onExport, onImport, onCommand, hasPersonalKey, onKeyCopy, onPublicKeyCopy, onKeyInsert, onKeyRotate, }) {
