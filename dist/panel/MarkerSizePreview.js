...
import { getMarkerScaleFactor, resolveMarkerBadgeDisplay, MARKER_BADGE_LABEL_CLASS, } from "../constants/markerAppearance.js";
import { getMarkerReplyBadgeSize, resolveMarkerGlyphPaint, resolveMarkerShapeStyle } from "../utils/marker/markerShape.js";
import { MarkerReplyBadge } from "../marker/MarkerReplyBadge.js";
import { MarkerShapeGlyph } from "../marker/MarkerShapeGlyph.js";
export function MarkerSizePreview({ size, fontSize, shape, color, fontFamily, fillStyle = "filled", strokeColor = "#ffffff", label = "1", ariaLabel, showReplyBadge = false, }) {
