...
const COPY: Record<Locale, ShowcaseCopy> = {
    ko: {
        ...
        features: {
            ...
            "element-hover-inspect": { title: "요소 하이라이트 Inspect", description: "피드백을 남길 때 요소에 올리면 하이라이트와 함께 태그·크기·여백 등 스타일 속성을 바로 확인합니다.", action: "카드에 마우스를 올려 스타일을 확인해보세요" },
            ...
            "settings-customization": { title: "테마와 언어 커스터마이징", description: "패널·툴팁 테마와 언어를 팀에 맞게 조정합니다.", action: "호버로 테마·언어 설정을 살펴보세요" },
            "settings-marker": { title: "개인 마커 커스터마이징", description: "마커 크기, 채움/외곽선 스타일, 모양을 개인 취향에 맞게 고릅니다.", action: "호버로 마커 커스터마이징을 살펴보세요" },
    ...
    en: {
        ...
        features: {
            ...
            "element-hover-inspect": { title: "Element highlight inspect", description: "While leaving feedback, hover an element to highlight it and peek tag, size, spacing, and style.", action: "Hover the cards to inspect styles" },
            ...
            "settings-customization": { title: "Theme and language", description: "Adjust panel and tooltip themes plus language for your team.", action: "Hover to explore theme and language" },
            "settings-marker": { title: "Personal marker styling", description: "Pick marker size, fill/outline style, and shape to match personal preference.", action: "Hover to explore marker customization" },
