...
const COPY: Record<Locale, ShowcaseCopy> = {
    ko: {
        ...
        features: {
            ...
            "element-inspector": { title: "말 대신 보여주는 UI Edit", description: "선택한 요소의 정보와 여백, 색상 변경 요청을 함께 전달합니다.", action: "호버로 Before와 After를 비교해보세요" },
            ...
            notifications: { title: "놓치지 않는 상태 변화", description: "편집 모드, 오류, 숨겨진 마커와 새로운 활동을 바로 확인합니다.", action: "호버로 알림 스택을 살펴보세요" },
        },
        install: {
    ...
    en: {
        ...
        features: {
            ...
            "element-inspector": { title: "Show changes with UI Edit", description: "Share the selected element, its spacing, and color changes together.", action: "Hover to compare Before and After" },
            ...
            notifications: { title: "Stay on top of changes", description: "See edit mode, errors, hidden markers, and new activity at once.", action: "Hover to explore the notification stack" },
        },
        install: {
            eyebrow: "Drop-in demo",
