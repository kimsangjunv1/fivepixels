...
const reviewers = [
    {
        id: "kim",
        name: "김담당",
        publicKey: import.meta.env.VITE_STITCHABLE_PUBLIC_KEY_KIM,
    },
    {
        id: "lee",
        name: "이담당",
        publicKey: import.meta.env.VITE_STITCHABLE_PUBLIC_KEY_LEE,
    },
];
...
담당자 API는 공개키를 포함해 반환하고, `<Report />`에는 조회 결과를 넘깁니다.
